...
public class DecomposedResourceIT {
  ...
  @Autowired private DecomposedMapper decomposedMapper;

  @Autowired private DecomposedService decomposedService;
  ...
  public void createDecomposed() throws Exception {
    ...
    restDecomposedMockMvc
        .perform(
            post("/api/decomposed-activities")
  ...
  public void getAllDecomposedActivities() throws Exception {
    ...
    restDecomposedMockMvc
        .perform(get("/api/decomposed-activities?sort=id,desc"))
  ...
  public void getDecomposed() throws Exception {
    ...
    // Get the decomposed
    restDecomposedMockMvc
        .perform(get("/api/decomposed-activities/{id}", decomposed.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingDecomposed() throws Exception {
    // Get the decomposed
    restDecomposedMockMvc
        .perform(get("/api/decomposed-activities/{id}", Long.MAX_VALUE))
  ...
  public void deleteDecomposed() throws Exception {
    ...
    restDecomposedMockMvc
        .perform(
            delete("/api/decomposed-activities/{id}", decomposed.getId())
