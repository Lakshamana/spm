...
public class GraphicCoordinateResourceIT {
  ...
  @Autowired private GraphicCoordinateMapper graphicCoordinateMapper;

  @Autowired private GraphicCoordinateService graphicCoordinateService;
  ...
  public void setup() {
    ...
    final GraphicCoordinateResource graphicCoordinateResource =
        new GraphicCoordinateResource(graphicCoordinateService);
  ...
  public void updateGraphicCoordinate() throws Exception {
    ...
    updatedGraphicCoordinate
        ...
        .visible(UPDATED_VISIBLE)
        .theProcess(UPDATED_THE_PROCESS);
    GraphicCoordinateDTO graphicCoordinateDTO =
        graphicCoordinateMapper.toDto(updatedGraphicCoordinate);
