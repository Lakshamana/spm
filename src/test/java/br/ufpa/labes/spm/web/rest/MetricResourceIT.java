...
public class MetricResourceIT {
  ...
  public void setup() {
    ...
    this.restMetricMockMvc =
        MockMvcBuilders.standaloneSetup(metricResource)
  ...
  public void getAllMetrics() throws Exception {
    ...
    restMetricMockMvc
        .perform(get("/api/metrics?sort=id,desc"))
  ...
  public void getMetric() throws Exception {
    ...
    // Get the metric
    restMetricMockMvc
        .perform(get("/api/metrics/{id}", metric.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingMetric() throws Exception {
    // Get the metric
    restMetricMockMvc
        .perform(get("/api/metrics/{id}", Long.MAX_VALUE))
  ...
  public void deleteMetric() throws Exception {
    ...
    // Delete the metric
    restMetricMockMvc
        .perform(delete("/api/metrics/{id}", metric.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
