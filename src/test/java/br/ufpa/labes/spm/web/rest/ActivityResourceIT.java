...
public class ActivityResourceIT {
  ...
  public static Activity createEntity(EntityManager em) {
    Activity activity = new Activity().ident(DEFAULT_IDENT).name(DEFAULT_NAME);
    return activity;
  }
  /**
  ...
  public static Activity createUpdatedEntity(EntityManager em) {
    Activity activity = new Activity().ident(UPDATED_IDENT).name(UPDATED_NAME);
    return activity;
  }
  ...
  public void getAllActivitiesWithEagerRelationshipsIsEnabled() throws Exception {
    ...
    when(activityServiceMock.findAllWithEagerRelationships(any()))
  ...
  public void updateActivity() throws Exception {
    ...
    updatedActivity.ident(UPDATED_IDENT).name(UPDATED_NAME);
