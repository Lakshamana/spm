...
public class BranchConCondToActivityResourceIT {
  ...
  @Autowired private BranchConCondToActivityMapper branchConCondToActivityMapper;

  @Autowired private BranchConCondToActivityService branchConCondToActivityService;
  ...
  public void setup() {
    ...
    final BranchConCondToActivityResource branchConCondToActivityResource =
        new BranchConCondToActivityResource(branchConCondToActivityService);
  ...
  public void createBranchConCondToActivity() throws Exception {
    ...
    BranchConCondToActivityDTO branchConCondToActivityDTO =
        branchConCondToActivityMapper.toDto(branchConCondToActivity);
  ...
  public void updateBranchConCondToActivity() throws Exception {
    ...
    BranchConCondToActivityDTO branchConCondToActivityDTO =
        branchConCondToActivityMapper.toDto(updatedBranchConCondToActivity);
