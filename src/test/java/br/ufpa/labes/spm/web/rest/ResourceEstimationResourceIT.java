...
public class ResourceEstimationResourceIT {
  ...
  @Autowired private ResourceEstimationMapper resourceEstimationMapper;

  @Autowired private ResourceEstimationService resourceEstimationService;
  ...
  public void setup() {
    ...
    final ResourceEstimationResource resourceEstimationResource =
        new ResourceEstimationResource(resourceEstimationService);
  ...
  public void createResourceEstimation() throws Exception {
    ...
    ResourceEstimationDTO resourceEstimationDTO =
        resourceEstimationMapper.toDto(resourceEstimation);
  ...
  public void updateResourceEstimation() throws Exception {
    ...
    ResourceEstimationDTO resourceEstimationDTO =
        resourceEstimationMapper.toDto(updatedResourceEstimation);
