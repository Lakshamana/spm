...
public class BranchConCondToMultipleConResourceIT {
  ...
  @Autowired private BranchConCondToMultipleConRepository branchCondToMultipleConRepository;

  @Autowired private BranchConCondToMultipleConMapper branchCondToMultipleConMapper;

  @Autowired private BranchConCondToMultipleConService branchCondToMultipleConService;
  ...
  public void setup() {
    ...
    final BranchConCondToMultipleConResource branchCondToMultipleConResource =
        new BranchConCondToMultipleConResource(branchCondToMultipleConService);
    this.restBranchConCondToMultipleConMockMvc =
        MockMvcBuilders.standaloneSetup(branchCondToMultipleConResource)
  ...
  public void createBranchConCondToMultipleCon() throws Exception {
    ...
    BranchConCondToMultipleConDTO branchCondToMultipleConDTO =
        branchCondToMultipleConMapper.toDto(branchCondToMultipleCon);
    restBranchConCondToMultipleConMockMvc
        .perform(
            post("/api/branch-cond-to-multiple-cons")
    ...
    List<BranchConCondToMultipleCon> branchCondToMultipleConList =
        branchCondToMultipleConRepository.findAll();
    ...
    BranchConCondToMultipleCon testBranchConCondToMultipleCon =
        branchCondToMultipleConList.get(branchCondToMultipleConList.size() - 1);
  }
  ...
  public void getAllBranchConCondToMultipleCons() throws Exception {
    ...
    restBranchConCondToMultipleConMockMvc
        .perform(get("/api/branch-cond-to-multiple-cons?sort=id,desc"))
  ...
  public void getBranchConCondToMultipleCon() throws Exception {
    ...
    restBranchConCondToMultipleConMockMvc
        .perform(get("/api/branch-cond-to-multiple-cons/{id}", branchCondToMultipleCon.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingBranchConCondToMultipleCon() throws Exception {
    // Get the branchCondToMultipleCon
    restBranchConCondToMultipleConMockMvc
        .perform(get("/api/branch-cond-to-multiple-cons/{id}", Long.MAX_VALUE))
  ...
  public void updateBranchConCondToMultipleCon() throws Exception {
    ...
    BranchConCondToMultipleCon updatedBranchConCondToMultipleCon =
        branchCondToMultipleConRepository.findById(branchCondToMultipleCon.getId()).get();
    ...
    BranchConCondToMultipleConDTO branchCondToMultipleConDTO =
        branchCondToMultipleConMapper.toDto(updatedBranchConCondToMultipleCon);

    restBranchConCondToMultipleConMockMvc
        .perform(
            put("/api/branch-cond-to-multiple-cons")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(branchCondToMultipleConDTO)))
        .andExpect(status().isOk());
  ...
  public void deleteBranchConCondToMultipleCon() throws Exception {
    ...
    restBranchConCondToMultipleConMockMvc
        .perform(
            delete("/api/branch-cond-to-multiple-cons/{id}", branchCondToMultipleCon.getId())
