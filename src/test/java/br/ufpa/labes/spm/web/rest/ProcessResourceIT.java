...
public class ProcessResourceIT {
  ...
  public static Process createEntity(EntityManager em) {
    Process process = new Process().ident(DEFAULT_IDENT).pStatus(DEFAULT_P_STATUS);
    return process;
  }
  /**
  ...
  public static Process createUpdatedEntity(EntityManager em) {
    Process process = new Process().ident(UPDATED_IDENT).pStatus(UPDATED_P_STATUS);
    return process;
  }
  ...
  public void updateProcess() throws Exception {
    ...
    updatedProcess.ident(UPDATED_IDENT).pStatus(UPDATED_P_STATUS);
