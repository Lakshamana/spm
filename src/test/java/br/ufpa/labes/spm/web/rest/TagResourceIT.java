...
public class TagResourceIT {
  ...
  public void setup() {
    ...
    this.restTagMockMvc =
        MockMvcBuilders.standaloneSetup(tagResource)
  ...
  public static Tag createEntity(EntityManager em) {
    Tag tag = new Tag().ident(DEFAULT_IDENT);
    return tag;
  }
  /**
  ...
  public static Tag createUpdatedEntity(EntityManager em) {
    Tag tag = new Tag().ident(UPDATED_IDENT);
    return tag;
  }
  ...
  public void updateTag() throws Exception {
    ...
    updatedTag.ident(UPDATED_IDENT);
  ...
  public void deleteTag() throws Exception {
    ...
    // Delete the tag
    restTagMockMvc
        .perform(delete("/api/tags/{id}", tag.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
