...
public class ScriptResourceIT {
  ...
  public void setup() {
    ...
    this.restScriptMockMvc =
        MockMvcBuilders.standaloneSetup(scriptResource)
  ...
  public static Script createEntity(EntityManager em) {
    Script script = new Script().fileName(DEFAULT_FILE_NAME).description(DEFAULT_DESCRIPTION);
    return script;
  }
  /**
  ...
  public static Script createUpdatedEntity(EntityManager em) {
    Script script = new Script().fileName(UPDATED_FILE_NAME).description(UPDATED_DESCRIPTION);
    return script;
  }
  ...
  public void getAllScripts() throws Exception {
    ...
    restScriptMockMvc
        .perform(get("/api/scripts?sort=id,desc"))
  ...
  public void getScript() throws Exception {
    ...
    // Get the script
    restScriptMockMvc
        .perform(get("/api/scripts/{id}", script.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingScript() throws Exception {
    // Get the script
    restScriptMockMvc
        .perform(get("/api/scripts/{id}", Long.MAX_VALUE))
  ...
  public void updateScript() throws Exception {
    ...
    updatedScript.fileName(UPDATED_FILE_NAME).description(UPDATED_DESCRIPTION);
  ...
  public void deleteScript() throws Exception {
    ...
    // Delete the script
    restScriptMockMvc
        .perform(delete("/api/scripts/{id}", script.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
