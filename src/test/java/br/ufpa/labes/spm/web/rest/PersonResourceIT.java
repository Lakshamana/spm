...
public class PersonResourceIT {
  ...
  public static Person createEntity(EntityManager em) {
    Person person = new Person().gender(DEFAULT_GENDER);
    return person;
  }
  /**
  ...
  public static Person createUpdatedEntity(EntityManager em) {
    Person person = new Person().gender(UPDATED_GENDER);
    return person;
  }
  ...
  public void getAllPeople() throws Exception {
    ...
    restPersonMockMvc
        .perform(get("/api/people?sort=id,desc"))
  ...
  public void getPerson() throws Exception {
    ...
    // Get the person
    restPersonMockMvc
        .perform(get("/api/people/{id}", person.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingPerson() throws Exception {
    // Get the person
    restPersonMockMvc
        .perform(get("/api/people/{id}", Long.MAX_VALUE))
  ...
  public void updatePerson() throws Exception {
    ...
    updatedPerson.gender(UPDATED_GENDER);
  ...
  public void deletePerson() throws Exception {
    ...
    // Delete the person
    restPersonMockMvc
        .perform(delete("/api/people/{id}", person.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
