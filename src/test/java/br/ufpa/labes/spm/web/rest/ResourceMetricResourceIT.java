...
public class ResourceMetricResourceIT {
  ...
  @Autowired private ResourceMetricMapper resourceMetricMapper;

  @Autowired private ResourceMetricService resourceMetricService;
  ...
  public void setup() {
    ...
    final ResourceMetricResource resourceMetricResource =
        new ResourceMetricResource(resourceMetricService);
