...
public class AgentInstSuggestionToAgentResourceIT {
  ...
  @Autowired private AgentInstSuggestionToAgentRepository agentInstSuggestionToAgentRepository;

  @Autowired private AgentInstSuggestionToAgentMapper agentInstSuggestionToAgentMapper;

  @Autowired private AgentInstSuggestionToAgentService agentInstSuggestionToAgentService;
  ...
  public void setup() {
    ...
    final AgentInstSuggestionToAgentResource agentInstSuggestionToAgentResource =
        new AgentInstSuggestionToAgentResource(agentInstSuggestionToAgentService);
    this.restAgentInstSuggestionToAgentMockMvc =
        MockMvcBuilders.standaloneSetup(agentInstSuggestionToAgentResource)
  ...
  public static AgentInstSuggestionToAgent createEntity(EntityManager em) {
    AgentInstSuggestionToAgent agentInstSuggestionToAgent =
        new AgentInstSuggestionToAgent().orderCriteriaResult(DEFAULT_ORDER_CRITERIA_RESULT);
  ...
  public static AgentInstSuggestionToAgent createUpdatedEntity(EntityManager em) {
    AgentInstSuggestionToAgent agentInstSuggestionToAgent =
        new AgentInstSuggestionToAgent().orderCriteriaResult(UPDATED_ORDER_CRITERIA_RESULT);
    return agentInstSuggestionToAgent;
  }
  ...
  public void createAgentInstSuggestionToAgent() throws Exception {
    ...
    AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO =
        agentInstSuggestionToAgentMapper.toDto(agentInstSuggestionToAgent);
    restAgentInstSuggestionToAgentMockMvc
        .perform(
            post("/api/agent-inst-suggestion-to-agents")
    ...
    List<AgentInstSuggestionToAgent> agentInstSuggestionToAgentList =
        agentInstSuggestionToAgentRepository.findAll();
    assertThat(agentInstSuggestionToAgentList).hasSize(databaseSizeBeforeCreate + 1);
    AgentInstSuggestionToAgent testAgentInstSuggestionToAgent =
        agentInstSuggestionToAgentList.get(agentInstSuggestionToAgentList.size() - 1);
    assertThat(testAgentInstSuggestionToAgent.getOrderCriteriaResult())
        .isEqualTo(DEFAULT_ORDER_CRITERIA_RESULT);
  }
  ...
  public void getAllAgentInstSuggestionToAgents() throws Exception {
    ...
    restAgentInstSuggestionToAgentMockMvc
        .perform(get("/api/agent-inst-suggestion-to-agents?sort=id,desc"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(
            jsonPath("$.[*].id").value(hasItem(agentInstSuggestionToAgent.getId().intValue())))
        .andExpect(
            jsonPath("$.[*].orderCriteriaResult")
                .value(hasItem(DEFAULT_ORDER_CRITERIA_RESULT.doubleValue())));
  }
  ...
  public void getAgentInstSuggestionToAgent() throws Exception {
    ...
    restAgentInstSuggestionToAgentMockMvc
        .perform(
            get("/api/agent-inst-suggestion-to-agents/{id}", agentInstSuggestionToAgent.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(jsonPath("$.id").value(agentInstSuggestionToAgent.getId().intValue()))
        .andExpect(
            jsonPath("$.orderCriteriaResult").value(DEFAULT_ORDER_CRITERIA_RESULT.doubleValue()));
  }
  ...
  public void getNonExistingAgentInstSuggestionToAgent() throws Exception {
    // Get the agentInstSuggestionToAgent
    restAgentInstSuggestionToAgentMockMvc
        .perform(get("/api/agent-inst-suggestion-to-agents/{id}", Long.MAX_VALUE))
  ...
  public void updateAgentInstSuggestionToAgent() throws Exception {
    ...
    AgentInstSuggestionToAgent updatedAgentInstSuggestionToAgent =
        agentInstSuggestionToAgentRepository.findById(agentInstSuggestionToAgent.getId()).get();
    // Disconnect from session so that the updates on updatedAgentInstSuggestionToAgent are not
    // directly saved in db
    em.detach(updatedAgentInstSuggestionToAgent);
    updatedAgentInstSuggestionToAgent.orderCriteriaResult(UPDATED_ORDER_CRITERIA_RESULT);
    AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO =
        agentInstSuggestionToAgentMapper.toDto(updatedAgentInstSuggestionToAgent);

    restAgentInstSuggestionToAgentMockMvc
        .perform(
            put("/api/agent-inst-suggestion-to-agents")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(agentInstSuggestionToAgentDTO)))
        .andExpect(status().isOk());
    ...
    AgentInstSuggestionToAgent testAgentInstSuggestionToAgent =
        agentInstSuggestionToAgentList.get(agentInstSuggestionToAgentList.size() - 1);
    assertThat(testAgentInstSuggestionToAgent.getOrderCriteriaResult())
        .isEqualTo(UPDATED_ORDER_CRITERIA_RESULT);
  }
  ...
  public void deleteAgentInstSuggestionToAgent() throws Exception {
    ...
    restAgentInstSuggestionToAgentMockMvc
        .perform(
            delete("/api/agent-inst-suggestion-to-agents/{id}", agentInstSuggestionToAgent.getId())
  ...
  public void dtoEqualsVerifier() throws Exception {
    ...
    AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO1 =
        new AgentInstSuggestionToAgentDTO();
    agentInstSuggestionToAgentDTO1.setId(1L);
    AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO2 =
        new AgentInstSuggestionToAgentDTO();
