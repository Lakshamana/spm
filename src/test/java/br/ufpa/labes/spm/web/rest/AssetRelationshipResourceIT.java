...
public class AssetRelationshipResourceIT {
  ...
  @Autowired private AssetRelationshipRepository assetRelationshipRepository;

  @Autowired private AssetRelationshipMapper assetRelationshipMapper;

  @Autowired private AssetRelationshipService assetRelationshipService;
  ...
  public void setup() {
    ...
    final AssetRelationshipResource assetRelationshipResource =
        new AssetRelationshipResource(assetRelationshipService);
    this.restAssetRelationshipMockMvc =
        MockMvcBuilders.standaloneSetup(assetRelationshipResource)
  ...
  public static AssetRelationship createEntity(EntityManager em) {
    AssetRelationship assetRelationship = new AssetRelationship().description(DEFAULT_DESCRIPTION);
  ...
  public static AssetRelationship createUpdatedEntity(EntityManager em) {
    AssetRelationship assetRelationship = new AssetRelationship().description(UPDATED_DESCRIPTION);
    return assetRelationship;
  }
  ...
  public void createAssetRelationship() throws Exception {
    ...
    AssetRelationshipDTO assetRelationshipDTO = assetRelationshipMapper.toDto(assetRelationship);
    restAssetRelationshipMockMvc
        .perform(
            post("/api/asset-relationships")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(assetRelationshipDTO)))
    ...
    AssetRelationship testAssetRelationship =
        assetRelationshipList.get(assetRelationshipList.size() - 1);
  ...
  public void getAllAssetRelationships() throws Exception {
    ...
    restAssetRelationshipMockMvc
        .perform(get("/api/asset-relationships?sort=id,desc"))
  ...
  public void getAssetRelationship() throws Exception {
    ...
    restAssetRelationshipMockMvc
        .perform(get("/api/asset-relationships/{id}", assetRelationship.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingAssetRelationship() throws Exception {
    // Get the assetRelationship
    restAssetRelationshipMockMvc
        .perform(get("/api/asset-relationships/{id}", Long.MAX_VALUE))
  ...
  public void updateAssetRelationship() throws Exception {
    ...
    AssetRelationship updatedAssetRelationship =
        assetRelationshipRepository.findById(assetRelationship.getId()).get();
    // Disconnect from session so that the updates on updatedAssetRelationship are not directly
    // saved in db
    em.detach(updatedAssetRelationship);
    updatedAssetRelationship.description(UPDATED_DESCRIPTION);
    AssetRelationshipDTO assetRelationshipDTO =
        assetRelationshipMapper.toDto(updatedAssetRelationship);

    restAssetRelationshipMockMvc
        .perform(
            put("/api/asset-relationships")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(assetRelationshipDTO)))
        .andExpect(status().isOk());
  ...
  public void deleteAssetRelationship() throws Exception {
    ...
    restAssetRelationshipMockMvc
        .perform(
            delete("/api/asset-relationships/{id}", assetRelationship.getId())
  ...
  public void dtoEqualsVerifier() throws Exception {
    TestUtil.equalsVerifier(AssetRelationshipDTO.class);
    AssetRelationshipDTO assetRelationshipDTO1 = new AssetRelationshipDTO();
    assetRelationshipDTO1.setId(1L);
    AssetRelationshipDTO assetRelationshipDTO2 = new AssetRelationshipDTO();
    assertThat(assetRelationshipDTO1).isNotEqualTo(assetRelationshipDTO2);
    assetRelationshipDTO2.setId(assetRelationshipDTO1.getId());
    assertThat(assetRelationshipDTO1).isEqualTo(assetRelationshipDTO2);
    assetRelationshipDTO2.setId(2L);
    assertThat(assetRelationshipDTO1).isNotEqualTo(assetRelationshipDTO2);
    assetRelationshipDTO1.setId(null);
    assertThat(assetRelationshipDTO1).isNotEqualTo(assetRelationshipDTO2);
  }
  ...
  public void testEntityFromId() {
    assertThat(assetRelationshipMapper.fromId(42L).getId()).isEqualTo(42);
    assertThat(assetRelationshipMapper.fromId(null)).isNull();
  }
}
