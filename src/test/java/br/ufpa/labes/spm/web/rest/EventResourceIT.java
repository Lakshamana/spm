...
public class EventResourceIT {
  ...
  public void setup() {
    ...
    this.restEventMockMvc =
        MockMvcBuilders.standaloneSetup(eventResource)
  ...
  public void getAllEvents() throws Exception {
    ...
    restEventMockMvc
        ...
        .andExpect(
            jsonPath("$.[*].isCreatedByApsee")
                .value(hasItem(DEFAULT_IS_CREATED_BY_APSEE.booleanValue())));
  }
  ...
  public void getEvent() throws Exception {
    ...
    restEventMockMvc
        ...
        .andExpect(
            jsonPath("$.isCreatedByApsee").value(DEFAULT_IS_CREATED_BY_APSEE.booleanValue()));
  }
  ...
  public void updateEvent() throws Exception {
    ...
    updatedEvent.why(UPDATED_WHY).when(UPDATED_WHEN).isCreatedByApsee(UPDATED_IS_CREATED_BY_APSEE);
  ...
  public void deleteEvent() throws Exception {
    ...
    // Delete the event
    restEventMockMvc
        .perform(delete("/api/events/{id}", event.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
