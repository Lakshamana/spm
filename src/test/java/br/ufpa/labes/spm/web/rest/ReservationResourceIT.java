...
public class ReservationResourceIT {
  ...
  public void setup() {
    ...
    this.restReservationMockMvc =
        MockMvcBuilders.standaloneSetup(reservationResource)
  ...
  public static Reservation createEntity(EntityManager em) {
    Reservation reservation = new Reservation().fromDate(DEFAULT_FROM_DATE).toDate(DEFAULT_TO_DATE);
    return reservation;
  }
  /**
  ...
  public static Reservation createUpdatedEntity(EntityManager em) {
    Reservation reservation = new Reservation().fromDate(UPDATED_FROM_DATE).toDate(UPDATED_TO_DATE);
    return reservation;
  }
  ...
  public void getAllReservations() throws Exception {
    ...
    restReservationMockMvc
        .perform(get("/api/reservations?sort=id,desc"))
  ...
  public void getNonExistingReservation() throws Exception {
    // Get the reservation
    restReservationMockMvc
        .perform(get("/api/reservations/{id}", Long.MAX_VALUE))
  ...
  public void updateReservation() throws Exception {
    ...
    // Disconnect from session so that the updates on updatedReservation are not directly saved in
    // db
    em.detach(updatedReservation);
    updatedReservation.fromDate(UPDATED_FROM_DATE).toDate(UPDATED_TO_DATE);
