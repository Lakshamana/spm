...
public class AbilityTypeResourceIT {
  ...
  @Autowired private AbilityTypeRepository abilityTypeRepository;

  @Autowired private AbilityTypeMapper abilityTypeMapper;

  @Autowired private AbilityTypeService abilityTypeService;
  ...
  public void setup() {
    ...
    this.restAbilityTypeMockMvc =
        MockMvcBuilders.standaloneSetup(abilityTypeResource)
  ...
  public void createAbilityType() throws Exception {
    ...
    restAbilityTypeMockMvc
        .perform(
            post("/api/ability-types")
  ...
  public void getAllAbilityTypes() throws Exception {
    ...
    restAbilityTypeMockMvc
        .perform(get("/api/ability-types?sort=id,desc"))
  ...
  public void getAbilityType() throws Exception {
    ...
    // Get the abilityType
    restAbilityTypeMockMvc
        .perform(get("/api/ability-types/{id}", abilityType.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingAbilityType() throws Exception {
    // Get the abilityType
    restAbilityTypeMockMvc
        .perform(get("/api/ability-types/{id}", Long.MAX_VALUE))
  ...
  public void updateAbilityType() throws Exception {
    ...
    // Disconnect from session so that the updates on updatedAbilityType are not directly saved in
    // db
  ...
  public void deleteAbilityType() throws Exception {
    ...
    restAbilityTypeMockMvc
        .perform(
            delete("/api/ability-types/{id}", abilityType.getId())
