...
public class VCSRepositoryResourceIT {
  ...
  public void setup() {
    ...
    final VCSRepositoryResource vCSRepositoryResource =
        new VCSRepositoryResource(vCSRepositoryRepository);
  ...
  public void getAllVCSRepositories() throws Exception {
    ...
    restVCSRepositoryMockMvc
        ...
        .andExpect(
            jsonPath("$.[*].connectionMethod").value(hasItem(DEFAULT_CONNECTION_METHOD.toString())))
        .andExpect(jsonPath("$.[*].repository").value(hasItem(DEFAULT_REPOSITORY.toString())))
        .andExpect(jsonPath("$.[*].username").value(hasItem(DEFAULT_USERNAME.toString())))
        .andExpect(jsonPath("$.[*].password").value(hasItem(DEFAULT_PASSWORD.toString())))
        .andExpect(
            jsonPath("$.[*].defaultUser").value(hasItem(DEFAULT_DEFAULT_USER.booleanValue())));
  }
