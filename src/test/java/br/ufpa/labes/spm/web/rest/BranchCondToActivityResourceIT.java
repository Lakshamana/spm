...
public class BranchConCondToActivityResourceIT {
  ...
  @Autowired private BranchConCondToActivityRepository branchCondToActivityRepository;

  @Autowired private BranchConCondToActivityMapper branchCondToActivityMapper;

  @Autowired private BranchConCondToActivityService branchCondToActivityService;
  ...
  public void setup() {
    ...
    final BranchConCondToActivityResource branchCondToActivityResource =
        new BranchConCondToActivityResource(branchCondToActivityService);
    this.restBranchConCondToActivityMockMvc =
        MockMvcBuilders.standaloneSetup(branchCondToActivityResource)
  ...
  public void createBranchConCondToActivity() throws Exception {
    ...
    BranchConCondToActivityDTO branchCondToActivityDTO =
        branchCondToActivityMapper.toDto(branchCondToActivity);
    restBranchConCondToActivityMockMvc
        .perform(
            post("/api/branch-cond-to-activities")
    ...
    List<BranchConCondToActivity> branchCondToActivityList =
        branchCondToActivityRepository.findAll();
    ...
    BranchConCondToActivity testBranchConCondToActivity =
        branchCondToActivityList.get(branchCondToActivityList.size() - 1);
  }
  ...
  public void getAllBranchConCondToActivities() throws Exception {
    ...
    restBranchConCondToActivityMockMvc
        .perform(get("/api/branch-cond-to-activities?sort=id,desc"))
  ...
  public void getBranchConCondToActivity() throws Exception {
    ...
    restBranchConCondToActivityMockMvc
        .perform(get("/api/branch-cond-to-activities/{id}", branchCondToActivity.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingBranchConCondToActivity() throws Exception {
    // Get the branchCondToActivity
    restBranchConCondToActivityMockMvc
        .perform(get("/api/branch-cond-to-activities/{id}", Long.MAX_VALUE))
  ...
  public void updateBranchConCondToActivity() throws Exception {
    ...
    BranchConCondToActivity updatedBranchConCondToActivity =
        branchCondToActivityRepository.findById(branchCondToActivity.getId()).get();
    ...
    BranchConCondToActivityDTO branchCondToActivityDTO =
        branchCondToActivityMapper.toDto(updatedBranchConCondToActivity);

    restBranchConCondToActivityMockMvc
        .perform(
            put("/api/branch-cond-to-activities")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(branchCondToActivityDTO)))
        .andExpect(status().isOk());
  ...
  public void deleteBranchConCondToActivity() throws Exception {
    ...
    restBranchConCondToActivityMockMvc
        .perform(
            delete("/api/branch-cond-to-activities/{id}", branchCondToActivity.getId())
