...
public class OrganizationResourceIT {
  ...
  public void setup() {
    ...
    final OrganizationResource organizationResource =
        new OrganizationResource(organizationRepository);
  ...
  public static Organization createEntity(EntityManager em) {
    Organization organization = new Organization().domain(DEFAULT_DOMAIN);
    return organization;
  }
  /**
  ...
  public static Organization createUpdatedEntity(EntityManager em) {
    Organization organization = new Organization().domain(UPDATED_DOMAIN);
    return organization;
  }
  ...
  public void getNonExistingOrganization() throws Exception {
    // Get the organization
    restOrganizationMockMvc
        .perform(get("/api/organizations/{id}", Long.MAX_VALUE))
  ...
  public void updateOrganization() throws Exception {
    ...
    // Disconnect from session so that the updates on updatedOrganization are not directly saved in
    // db
    em.detach(updatedOrganization);
    updatedOrganization.domain(UPDATED_DOMAIN);
