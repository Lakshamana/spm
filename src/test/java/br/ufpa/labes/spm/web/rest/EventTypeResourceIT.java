...
public class EventTypeResourceIT {
  ...
  @Autowired private EventTypeMapper eventTypeMapper;
  ...
  public void setup() {
    ...
    this.restEventTypeMockMvc =
        MockMvcBuilders.standaloneSetup(eventTypeResource)
  ...
  public void getAllEventTypes() throws Exception {
    ...
    restEventTypeMockMvc
        .perform(get("/api/event-types?sort=id,desc"))
  ...
  public void getEventType() throws Exception {
    ...
    // Get the eventType
    restEventTypeMockMvc
        .perform(get("/api/event-types/{id}", eventType.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingEventType() throws Exception {
    // Get the eventType
    restEventTypeMockMvc
        .perform(get("/api/event-types/{id}", Long.MAX_VALUE))
  ...
  public void deleteEventType() throws Exception {
    ...
    restEventTypeMockMvc
        .perform(
            delete("/api/event-types/{id}", eventType.getId())
