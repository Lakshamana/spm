...
public class EmailResourceIT {
  ...
  public void setup() {
    ...
    this.restEmailMockMvc =
        MockMvcBuilders.standaloneSetup(emailResource)
  ...
  public void getAllEmails() throws Exception {
    ...
    restEmailMockMvc
        .perform(get("/api/emails?sort=id,desc"))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(jsonPath("$.[*].id").value(hasItem(email.getId().intValue())))
        .andExpect(
            jsonPath("$.[*].emailServerHost").value(hasItem(DEFAULT_EMAIL_SERVER_HOST.toString())))
        .andExpect(
            jsonPath("$.[*].emailServerPort").value(hasItem(DEFAULT_EMAIL_SERVER_PORT.toString())))
  ...
  public void getEmail() throws Exception {
    ...
    // Get the email
    restEmailMockMvc
        .perform(get("/api/emails/{id}", email.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingEmail() throws Exception {
    // Get the email
    restEmailMockMvc
        .perform(get("/api/emails/{id}", Long.MAX_VALUE))
  ...
  public void deleteEmail() throws Exception {
    ...
    // Delete the email
    restEmailMockMvc
        .perform(delete("/api/emails/{id}", email.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
