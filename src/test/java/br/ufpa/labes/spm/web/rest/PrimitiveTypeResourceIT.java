...
public class PrimitiveTypeResourceIT {
  ...
  @Autowired private PrimitiveTypeMapper primitiveTypeMapper;

  @Autowired private PrimitiveTypeService primitiveTypeService;
  ...
  public void setup() {
    ...
    final PrimitiveTypeResource primitiveTypeResource =
        new PrimitiveTypeResource(primitiveTypeService);
