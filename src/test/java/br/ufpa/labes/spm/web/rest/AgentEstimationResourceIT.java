...
public class AgentEstimationResourceIT {
  ...
  @Autowired private AgentEstimationMapper agentEstimationMapper;

  @Autowired private AgentEstimationService agentEstimationService;
  ...
  public void setup() {
    ...
    final AgentEstimationResource agentEstimationResource =
        new AgentEstimationResource(agentEstimationService);
