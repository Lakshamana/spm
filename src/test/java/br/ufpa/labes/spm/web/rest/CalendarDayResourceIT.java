...
public class CalendarDayResourceIT {
    ...
    public void setup() {
        ...
        this.restCalendarDayMockMvc = MockMvcBuilders.standaloneSetup(calendarDayResource)
    ...
    public void createCalendarDay() throws Exception {
        ...
        restCalendarDayMockMvc.perform(post("/api/calendar-days")
    ...
    public void getAllCalendarDays() throws Exception {
        ...
        restCalendarDayMockMvc.perform(get("/api/calendar-days?sort=id,desc"))
    ...
    public void getCalendarDay() throws Exception {
        ...
        // Get the calendarDay
        restCalendarDayMockMvc.perform(get("/api/calendar-days/{id}", calendarDay.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getNonExistingCalendarDay() throws Exception {
        // Get the calendarDay
        restCalendarDayMockMvc.perform(get("/api/calendar-days/{id}", Long.MAX_VALUE))
    ...
    public void updateCalendarDay() throws Exception {
        ...
        restCalendarDayMockMvc.perform(put("/api/calendar-days")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(calendarDayDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteCalendarDay() throws Exception {
        ...
        restCalendarDayMockMvc.perform(delete("/api/calendar-days/{id}", calendarDay.getId())
