...
public class EmailConfigurationResourceIT {
  ...
  public void setup() {
    ...
    final EmailConfigurationResource emailConfigurationResource =
        new EmailConfigurationResource(emailConfigurationRepository);
  ...
  public void createEmailConfiguration() throws Exception {
    ...
    assertThat(testEmailConfiguration.isDecisionBranchCond())
        .isEqualTo(DEFAULT_DECISION_BRANCH_COND);
  }
  ...
  public void getAllEmailConfigurations() throws Exception {
    ...
    restEmailConfigurationMockMvc
        ...
        .andExpect(
            jsonPath("$.[*].decisionBranchCond")
                .value(hasItem(DEFAULT_DECISION_BRANCH_COND.booleanValue())));
  }
  ...
  public void getEmailConfiguration() throws Exception {
    ...
    restEmailConfigurationMockMvc
        ...
        .andExpect(
            jsonPath("$.decisionBranchCond").value(DEFAULT_DECISION_BRANCH_COND.booleanValue()));
  }
  ...
  public void updateEmailConfiguration() throws Exception {
    ...
    assertThat(testEmailConfiguration.isDecisionBranchCond())
        .isEqualTo(UPDATED_DECISION_BRANCH_COND);
  }
