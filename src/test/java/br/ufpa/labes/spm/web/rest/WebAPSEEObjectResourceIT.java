...
public class WebAPSEEObjectResourceIT {
  ...
  private static final WebAPSEEObjectType DEFAULT_WEB_APSEE_OBJECT_TYPE =
      WebAPSEEObjectType.ACTIVITY;
  private static final WebAPSEEObjectType UPDATED_WEB_APSEE_OBJECT_TYPE =
      WebAPSEEObjectType.REQ_AGENT;

  @Autowired private WebAPSEEObjectRepository webAPSEEObjectRepository;

  @Autowired private WebAPSEEObjectMapper webAPSEEObjectMapper;

  @Autowired private WebAPSEEObjectService webAPSEEObjectService;
  ...
  public void setup() {
    ...
    final WebAPSEEObjectResource webAPSEEObjectResource =
        new WebAPSEEObjectResource(webAPSEEObjectService);
  ...
  public void getAllWebAPSEEObjects() throws Exception {
    ...
    restWebAPSEEObjectMockMvc
        ...
        .andExpect(
            jsonPath("$.[*].webAPSEEObjectType")
                .value(hasItem(DEFAULT_WEB_APSEE_OBJECT_TYPE.toString())));
  }
  ...
  public void getWebAPSEEObject() throws Exception {
    ...
    restWebAPSEEObjectMockMvc
        ...
        .andExpect(
            jsonPath("$.webAPSEEObjectType").value(DEFAULT_WEB_APSEE_OBJECT_TYPE.toString()));
  }
