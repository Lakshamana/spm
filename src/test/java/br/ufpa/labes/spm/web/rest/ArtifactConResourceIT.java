...
public class ArtifactConResourceIT {
  ...
  @Mock private ArtifactConService artifactConServiceMock;

  @Autowired private ArtifactConService artifactConService;
  ...
  public void getAllArtifactConsWithEagerRelationshipsIsEnabled() throws Exception {
    ...
    when(artifactConServiceMock.findAllWithEagerRelationships(any()))
