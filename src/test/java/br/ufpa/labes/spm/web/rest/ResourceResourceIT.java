...
public class ResourceResourceIT {
  ...
  @Mock private ResourceRepository resourceRepositoryMock;
  ...
  public void setup() {
    ...
    this.restResourceMockMvc =
        MockMvcBuilders.standaloneSetup(resourceResource)
  ...
  public void getAllResourcesWithEagerRelationshipsIsEnabled() throws Exception {
    ...
    when(resourceRepositoryMock.findAllWithEagerRelationships(any()))
        .thenReturn(new PageImpl(new ArrayList<>()));

    MockMvc restResourceMockMvc =
        MockMvcBuilders.standaloneSetup(resourceResource)
            .setCustomArgumentResolvers(pageableArgumentResolver)
            .setControllerAdvice(exceptionTranslator)
            .setConversionService(createFormattingConversionService())
    ...
    restResourceMockMvc.perform(get("/api/resources?eagerload=true")).andExpect(status().isOk());
  ...
  public void getNonExistingResource() throws Exception {
    // Get the resource
    restResourceMockMvc
        .perform(get("/api/resources/{id}", Long.MAX_VALUE))
  ...
  public void deleteResource() throws Exception {
    ...
    restResourceMockMvc
        .perform(
            delete("/api/resources/{id}", resource.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
