...
public class ProcessMetricResourceIT {
  ...
  @Autowired private ProcessMetricMapper processMetricMapper;

  @Autowired private ProcessMetricService processMetricService;
  ...
  public void setup() {
    ...
    final ProcessMetricResource processMetricResource =
        new ProcessMetricResource(processMetricService);
