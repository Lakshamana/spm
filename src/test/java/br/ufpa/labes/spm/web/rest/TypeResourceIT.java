...
public class TypeResourceIT {
  ...
  public void setup() {
    ...
    this.restTypeMockMvc =
        MockMvcBuilders.standaloneSetup(typeResource)
  ...
  public void getAllTypes() throws Exception {
    ...
    restTypeMockMvc
        .perform(get("/api/types?sort=id,desc"))
        ...
        .andExpect(
            jsonPath("$.[*].userDefined").value(hasItem(DEFAULT_USER_DEFINED.booleanValue())));
  }
  ...
  public void getType() throws Exception {
    ...
    // Get the type
    restTypeMockMvc
        .perform(get("/api/types/{id}", type.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingType() throws Exception {
    // Get the type
    restTypeMockMvc
        .perform(get("/api/types/{id}", Long.MAX_VALUE))
  ...
  public void deleteType() throws Exception {
    ...
    // Delete the type
    restTypeMockMvc
        .perform(delete("/api/types/{id}", type.getId()).accept(TestUtil.APPLICATION_JSON_UTF8))
