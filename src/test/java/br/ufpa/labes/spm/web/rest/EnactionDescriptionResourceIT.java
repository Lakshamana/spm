...
public class EnactionDescriptionResourceIT {
  ...
  @Autowired private EnactionDescriptionRepository enactionDescriptionRepository;

  @Autowired private EnactionDescriptionMapper enactionDescriptionMapper;

  @Autowired private EnactionDescriptionService enactionDescriptionService;
  ...
  public void setup() {
    ...
    final EnactionDescriptionResource enactionDescriptionResource =
        new EnactionDescriptionResource(enactionDescriptionService);
    this.restEnactionDescriptionMockMvc =
        MockMvcBuilders.standaloneSetup(enactionDescriptionResource)
  ...
  public static EnactionDescription createEntity(EntityManager em) {
    EnactionDescription enactionDescription =
        new EnactionDescription()
  ...
  public void createEnactionDescription() throws Exception {
    ...
    EnactionDescriptionDTO enactionDescriptionDTO =
        enactionDescriptionMapper.toDto(enactionDescription);
    restEnactionDescriptionMockMvc
        .perform(
            post("/api/enaction-descriptions")
    ...
    EnactionDescription testEnactionDescription =
        enactionDescriptionList.get(enactionDescriptionList.size() - 1);
  ...
  public void getAllEnactionDescriptions() throws Exception {
    ...
    restEnactionDescriptionMockMvc
        .perform(get("/api/enaction-descriptions?sort=id,desc"))
  ...
  public void getEnactionDescription() throws Exception {
    ...
    restEnactionDescriptionMockMvc
        .perform(get("/api/enaction-descriptions/{id}", enactionDescription.getId()))
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
  ...
  public void getNonExistingEnactionDescription() throws Exception {
    // Get the enactionDescription
    restEnactionDescriptionMockMvc
        .perform(get("/api/enaction-descriptions/{id}", Long.MAX_VALUE))
  ...
  public void updateEnactionDescription() throws Exception {
    ...
    EnactionDescription updatedEnactionDescription =
        enactionDescriptionRepository.findById(enactionDescription.getId()).get();
    // Disconnect from session so that the updates on updatedEnactionDescription are not directly
    // saved in db
    ...
    updatedEnactionDescription
        ...
        .state(UPDATED_STATE);
    EnactionDescriptionDTO enactionDescriptionDTO =
        enactionDescriptionMapper.toDto(updatedEnactionDescription);

    restEnactionDescriptionMockMvc
        .perform(
            put("/api/enaction-descriptions")
                .contentType(TestUtil.APPLICATION_JSON_UTF8)
                .content(TestUtil.convertObjectToJsonBytes(enactionDescriptionDTO)))
        .andExpect(status().isOk());
  ...
  public void deleteEnactionDescription() throws Exception {
    ...
    restEnactionDescriptionMockMvc
        .perform(
            delete("/api/enaction-descriptions/{id}", enactionDescription.getId())
