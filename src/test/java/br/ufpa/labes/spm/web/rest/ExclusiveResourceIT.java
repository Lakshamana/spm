...
public class ExclusiveResourceIT {
  ...
  public static Exclusive createEntity(EntityManager em) {
    Exclusive exclusive = new Exclusive().state(DEFAULT_STATE).unitOfCost(DEFAULT_UNIT_OF_COST);
    return exclusive;
  }
  /**
  ...
  public static Exclusive createUpdatedEntity(EntityManager em) {
    Exclusive exclusive = new Exclusive().state(UPDATED_STATE).unitOfCost(UPDATED_UNIT_OF_COST);
    return exclusive;
  }
  ...
  public void updateExclusive() throws Exception {
    ...
    updatedExclusive.state(UPDATED_STATE).unitOfCost(UPDATED_UNIT_OF_COST);
