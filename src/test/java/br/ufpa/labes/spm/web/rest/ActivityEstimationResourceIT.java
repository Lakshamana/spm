...
public class ActivityEstimationResourceIT {
  ...
  @Autowired private ActivityEstimationMapper activityEstimationMapper;

  @Autowired private ActivityEstimationService activityEstimationService;
  ...
  public void setup() {
    ...
    final ActivityEstimationResource activityEstimationResource =
        new ActivityEstimationResource(activityEstimationService);
  ...
  public void createActivityEstimation() throws Exception {
    ...
    ActivityEstimationDTO activityEstimationDTO =
        activityEstimationMapper.toDto(activityEstimation);
  ...
  public void updateActivityEstimation() throws Exception {
    ...
    ActivityEstimationDTO activityEstimationDTO =
        activityEstimationMapper.toDto(updatedActivityEstimation);
