...
public class EventDTO implements Serializable {
    ...
    public String toString() {
        return "EventDTO{" +
            ...
            ", theAgendaEventSub=" + getTheAgendaEventSubId() +
            ", theCatalogEventSub=" + getTheCatalogEventSubId() +
            ", theConnectionEventSub=" + getTheConnectionEventSubId() +
            ", theGlobalActivityEventSub=" + getTheGlobalActivityEventSubId() +
            ", theModelingActivityEventSub=" + getTheModelingActivityEventSubId() +
            ", theProcessEventSub=" + getTheProcessEventSubId() +
            ", theProcessModelEventSub=" + getTheProcessModelEventSubId() +
            ", theResourceEventSub=" + getTheResourceEventSubId() +
