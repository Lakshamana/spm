...
public class MetricDTO implements Serializable {
  ...
  public String toString() {
    return "MetricDTO{"
        ...
        + getPeriodEnd()
        + "'"
        + ", theActivityMetricSub="
        + getTheActivityMetricSubId()
        + ", theAgentMetricSub="
        + getTheAgentMetricSubId()
        + ", theArtifactMetricSub="
        + getTheArtifactMetricSubId()
        + ", theWorkGroupMetricSub="
        + getTheWorkGroupMetricSubId()
        + ", theOrganizationMetricSub="
        + getTheOrganizationMetricSubId()
        + ", theProcessMetricSub="
        + getTheProcessMetricSubId()
        + ", theResourceMetricSub="
        + getTheResourceMetricSubId()
        + ", theMetricDefinition="
