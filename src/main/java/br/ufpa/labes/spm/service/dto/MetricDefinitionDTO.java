...
public class MetricDefinitionDTO implements Serializable {
    ...
    public Long getTheMetricTypeId() {
        return theMetricTypeId;
    }

    public void setTheMetricTypeId(Long metricTypeId) {
        this.theMetricTypeId = metricTypeId;
    }
    ...
    public String toString() {
        return "MetricDefinitionDTO{" +
            ...
            ", theMetricType=" + getTheMetricTypeId() +
            "}";
    }
}
