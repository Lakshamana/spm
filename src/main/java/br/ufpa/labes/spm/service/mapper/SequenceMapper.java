...
public interface SequenceMapper extends EntityMapper<SequenceDTO, Sequence> {
  ...
  @Mapping(
      source = "theDependencyToMultipleSequences.id",
      target = "theDependencyToMultipleSequencesId")
  SequenceDTO toDto(Sequence sequence);

  @Mapping(
      source = "theDependencyToMultipleSequencesId",
      target = "theDependencyToMultipleSequences")
