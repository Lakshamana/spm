...
/**
 * Mapper for the entity {@link ReqAgentRequiresAbility} and its DTO {@link
 * ReqAgentRequiresAbilityDTO}.
 */
@Mapper(
    componentModel = "spring",
    uses = {RequiredPeopleMapper.class, AbilityMapper.class})
public interface ReqAgentRequiresAbilityMapper
    extends EntityMapper<ReqAgentRequiresAbilityDTO, ReqAgentRequiresAbility> {
