 ...
 */
@Mapper(componentModel = "spring", uses = {MultipleConMapper.class, SimpleConMapper.class, ArtifactConMapper.class, ProcessModelMapper.class, ConnectionTypeMapper.class})
