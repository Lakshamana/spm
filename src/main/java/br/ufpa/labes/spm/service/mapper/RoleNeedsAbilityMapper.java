 ...
 */
@Mapper(componentModel = "spring", uses = {RoleMapper.class, AbilityMapper.class})
public interface RoleNeedsAbilityMapper extends EntityMapper<RoleNeedsAbilityDTO, RoleNeedsAbility> {
