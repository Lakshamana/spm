...
@Mapper(
    ...
    uses = {
      ActivityMetricMapper.class,
      AgentMetricMapper.class,
      ArtifactMetricMapper.class,
      WorkGroupMetricMapper.class,
      OrganizationMetricMapper.class,
      ProcessMetricMapper.class,
      ResourceMetricMapper.class,
