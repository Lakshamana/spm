 ...
 */
@Mapper(componentModel = "spring", uses = {AbilityTypeMapper.class, ActivityTypeMapper.class, ArtifactTypeMapper.class, ConnectionTypeMapper.class, EventTypeMapper.class, WorkGroupTypeMapper.class, MetricTypeMapper.class, ResourceTypeMapper.class, RoleTypeMapper.class, ToolTypeMapper.class})
