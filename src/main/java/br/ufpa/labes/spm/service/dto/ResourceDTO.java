...
public class ResourceDTO implements Serializable {
  ...
  @IgnoreMapping private String mtbfTime;
  private String mtbfUnitTime;
  @IgnoreMapping private String cost;
  private String costString;
  private String currency;
  private Boolean staticOk;
  private Boolean isActive; // Added in 13/07/2008 by Murilo

  @IgnoreMapping private String belongsTo;
  @IgnoreMapping private String theResourceType;
  @IgnoreMapping private Collection<String> requires;
  @IgnoreMapping private Collection<String> isRequired;
