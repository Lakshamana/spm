...
public class ActivityDTO implements Serializable {
  ...
  public Long getThePlainSubId() {
    return thePlainSubId;
  }

  public void setThePlainSubId(Long plainId) {
    this.thePlainSubId = plainId;
  }
  ...
  public String toString() {
    return "ActivityDTO{"
        ...
        + getThePlainSubId()
        + ", theDecomposedSub="
        + getTheDecomposedSubId()
        + ", theActivityType="
        + getTheActivityTypeId()
        + ", theAncestorActitvity="
        + getTheAncestorActitvityId()
        + ", theProcessModel="
