...
public class EstimationDTO implements Serializable {
    ...
    public String toString() {
        return "EstimationDTO{" +
            ...
            ", value=" + getValue() +
            ", unit='" + getUnit() + "'" +
            ", theActivityEstimationSub=" + getTheActivityEstimationSubId() +
            ", theAgentEstimationSub=" + getTheAgentEstimationSubId() +
            ", theArtifactEstimationSub=" + getTheArtifactEstimationSubId() +
            ", theWorkGroupEstimationSub=" + getTheWorkGroupEstimationSubId() +
            ", theOrganizationEstimationSub=" + getTheOrganizationEstimationSubId() +
            ", theProcessEstimationSub=" + getTheProcessEstimationSubId() +
            ", theResourceEstimationSub=" + getTheResourceEstimationSubId() +
