...
public class ProjectCopyDTO implements Serializable {
  ...
  @IgnoreMapping private Collection<SimpleUpdateDTO> artifacts;
  @IgnoreMapping private boolean reuse;
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((newIdent == null) ? 0 : newIdent.hashCode());
    result = prime * result + ((oldIdent == null) ? 0 : oldIdent.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (newIdent == null) {
      if (other.newIdent != null) return false;
    } else if (!newIdent.equals(other.newIdent)) return false;
    if (oldIdent == null) {
      if (other.oldIdent != null) return false;
    } else if (!oldIdent.equals(other.oldIdent)) return false;
    return true;
  }
}
