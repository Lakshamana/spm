...
@Mapper(
    ...
    uses = {RelationshipKindMapper.class, AssetMapper.class})
public interface AssetRelationshipMapper
    extends EntityMapper<AssetRelationshipDTO, AssetRelationship> {
