...
public class ProcessDTO implements Serializable {
    ...
    public Long getTheTemplateSubId() {
        return theTemplateSubId;
    }

    public void setTheTemplateSubId(Long templateId) {
        this.theTemplateSubId = templateId;
    }
    ...
    public String toString() {
        return "ProcessDTO{" +
            ...
            ", theTemplateSub=" + getTheTemplateSubId() +
