...
public class TypeDTO implements Serializable {
    ...
    public String toString() {
        return "TypeDTO{" +
            ...
            ", theAbilityTypeSub=" + getTheAbilityTypeSubId() +
            ", theActivityTypeSub=" + getTheActivityTypeSubId() +
            ", theArtifactTypeSub=" + getTheArtifactTypeSubId() +
            ", theConnectionTypeSub=" + getTheConnectionTypeSubId() +
            ", theEventTypeSub=" + getTheEventTypeSubId() +
            ", theWorkGroupTypeSub=" + getTheWorkGroupTypeSubId() +
            ", theMetricTypeSub=" + getTheMetricTypeSubId() +
            ", theResourceTypeSub=" + getTheResourceTypeSubId() +
            ", theRoleTypeSub=" + getTheRoleTypeSubId() +
            ", theToolTypeSub=" + getTheToolTypeSubId() +
