 ...
 */
@Mapper(componentModel = "spring", uses = {PlainActivityMapper.class, DecomposedActivityMapper.class, ActivityTypeMapper.class, JoinConMapper.class, BranchANDConMapper.class, ArtifactConMapper.class, ProcessModelMapper.class})
public interface ActivityMapper extends EntityMapper<ActivityDTO, Activity> {

    @Mapping(source = "thePlainActivitySub.id", target = "thePlainActivitySubId")
    @Mapping(source = "theDecomposedActivitySub.id", target = "theDecomposedActivitySubId")
    ...
    @Mapping(source = "theDecomposedActivitySubId", target = "theDecomposedActivitySub")
