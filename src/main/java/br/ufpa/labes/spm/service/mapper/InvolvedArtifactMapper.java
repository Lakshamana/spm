 ...
 */
@Mapper(componentModel = "spring", uses = {NormalMapper.class, ArtifactTypeMapper.class, ArtifactMapper.class})
public interface InvolvedArtifactMapper extends EntityMapper<InvolvedArtifactDTO, InvolvedArtifact> {
