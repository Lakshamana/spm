...
@Mapper(
    ...
    uses = {
      ActivityEstimationMapper.class,
      AgentEstimationMapper.class,
      ArtifactEstimationMapper.class,
      WorkGroupEstimationMapper.class,
      OrganizationEstimationMapper.class,
      ProcessEstimationMapper.class,
      ResourceEstimationMapper.class,
      MetricDefinitionMapper.class
    })
