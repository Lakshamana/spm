 ...
 */
@Mapper(componentModel = "spring", uses = {ConsumableMapper.class, ExclusiveMapper.class, ShareableMapper.class, ResourceTypeMapper.class})
public interface ResourceMapper extends EntityMapper<ResourceDTO, Resource> {

    @Mapping(source = "theConsumableSub.id", target = "theConsumableSubId")
    @Mapping(source = "theExclusiveSub.id", target = "theExclusiveSubId")
    @Mapping(source = "theShareableSub.id", target = "theShareableSubId")
    @Mapping(source = "belongsTo.id", target = "belongsToId")
    @Mapping(source = "theResourceType.id", target = "theResourceTypeId")
    ResourceDTO toDto(Resource resource);

    @Mapping(source = "theConsumableSubId", target = "theConsumableSub")
    @Mapping(source = "theExclusiveSubId", target = "theExclusiveSub")
    @Mapping(source = "theShareableSubId", target = "theShareableSub")
