...
public interface WorkGroupInstSugRepository extends JpaRepository<WorkGroupInstSug, Long> {
  ...
  @Query(
      value =
          "select distinct workGroupInstSug from WorkGroupInstSug workGroupInstSug left join fetch workGroupInstSug.groupSuggesteds",
  ...
  @Query(
      "select workGroupInstSug from WorkGroupInstSug workGroupInstSug left join fetch workGroupInstSug.groupSuggesteds where workGroupInstSug.id =:id")
