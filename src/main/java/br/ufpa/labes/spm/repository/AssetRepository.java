...
public interface AssetRepository extends JpaRepository<Asset, Long> {
  ...
  @Query(
      value =
          "select distinct asset from Asset asset left join fetch asset.favoritedBies left join fetch asset.followers left join fetch asset.collaborators",
  ...
  @Query(
      "select asset from Asset asset left join fetch asset.favoritedBies left join fetch asset.followers left join fetch asset.collaborators where asset.id =:id")
