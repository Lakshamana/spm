...
public class UtilReflection {
	...
	//parametro nao eh collection, mas precisamos a partir do parameter type descobrir se eh preciso ou na opopular uma collection para invocar o metodo
	public static Object invocarMetodoSetpecial(Object objetoDoMetodo,String nomeDoMetodo, Object parametros) {
		try {
			...
			if(containsCollectionType(para_types)){
				...
				Method metodo = objetoDoMetodo.getClass().getMethod(nomeDoMetodo,getClasseDoParameter(objetoDoMetodo.getClass(),nomeDoMetodo));
	...
	public static Object invokeMethodOld(Object objetoDoMetodo,String nomeDoMetodo, Object[] parametros) {
		try {
			Method metodo = objetoDoMetodo.getClass().getMethod(nomeDoMetodo,getClasseDoParameter(objetoDoMetodo.getClass(),nomeDoMetodo));
			return metodo.invoke(objetoDoMetodo,parametros);
		} catch (Throwable e) {
...
*/
	...
	public static Object invokeMethod(Class classeDoMetodo, String nomeDoMetodo, Object[] parametros) {
		try {
			Method metodo = classeDoMetodo.getMethod(nomeDoMetodo,getClasseDoParameter(classeDoMetodo,nomeDoMetodo));
	...
	public static String getMethodNameFromParameter(Class parameter,Object obj) {
		...
		//try to find the correct class using super classes definition --> after improve optmization of this source
	...
	public static Object[] copyGenericArrayValues(String parameterClassName, Object[] values,int arraySize) {
		try {
			...
			for (int i = 0; i < arraySize; i++) {
				...
				BeanUtils.copyProperties(parameterCorrectValue,
						notInParameterValue);
