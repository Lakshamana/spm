...
public class SemCaracteresEspeciais implements MetodoDeConversao {
	...
	public static void main(String[] args) {
		String ok = ConversorDeIdent.de("1752 Plano de AÃ§Ã£o1").para(new SemCaracteresEspeciais()).ident();
		System.out.println(ok);
		
		String ok2 = ConversorDeIdent.de("872.Template - Plano de Gerência de Documentos e Plano de Comunicação").para(new SemCaracteresEspeciais()).ident();
