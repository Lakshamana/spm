...
public class InvolvedArtifact implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("theInvolvedArtifactToNormals")
    private Normal inInvolvedArtifacts;

    @ManyToOne
    @JsonIgnoreProperties("theInvolvedArtifactsFromNormals")
    ...
    public void removeFromTheArtifact(){
      if (this.theArtifact!=null){
        this.theArtifact.removeTheInvolvedArtifacts(this);
      }
    }

    public void insertIntoTheArtifact(Artifact theArtifact){
