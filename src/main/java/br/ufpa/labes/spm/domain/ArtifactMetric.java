...
public class ArtifactMetric extends Metric implements Serializable {
  ...
  @OneToOne(mappedBy = "theArtifactMetricSub")
  @JsonIgnore
  ...
  public ArtifactMetric theMetricSuper(Metric metric) {
  ...
  public ArtifactMetric theArtifact(Artifact artifact) {
  ...
  public String toString() {
    return "ArtifactMetric{" + "id=" + getId() + "}";
  }
}
