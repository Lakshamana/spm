...
public class Author implements Serializable {
  ...
  @OneToOne
  @JoinColumn(unique = true)
  private Organization theOrganizationSub;

  @OneToOne
  @JoinColumn(unique = true)
  private Person thePersonSub;

  @ManyToMany
  @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
  @JoinTable(
      name = "author_authors_followed",
  ...
  public Organization getTheOrganizationSub() {
    return theOrganizationSub;
  }

  public Author theOrganizationSub(Organization organization) {
    this.theOrganizationSub = organization;
    return this;
  }

  public void setTheOrganizationSub(Organization organization) {
    this.theOrganizationSub = organization;
  }

  public Person getThePersonSub() {
    return thePersonSub;
  }

  public Author thePersonSub(Person person) {
    this.thePersonSub = person;
    return this;
  }

  public void setThePersonSub(Person person) {
    this.thePersonSub = person;
  }
