...
public class Organization extends Author implements Serializable {
  ...
  @OneToOne(mappedBy = "theOrganizationSub")
  @JsonIgnore
  ...
  public Organization theAuthorSuper(Author author) {
  ...
  public Organization theOrganizationEstimations(
      Set<OrganizationEstimation> organizationEstimations) {
  ...
  public Organization removeTheOrganizationEstimation(
  ...
  public String toString() {
    return "Organization{" + "id=" + getId() + ", domain='" + getDomain() + "'" + "}";
  }
}
