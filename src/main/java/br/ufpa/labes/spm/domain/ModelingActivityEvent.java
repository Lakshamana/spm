...
public class ModelingActivityEvent extends Event implements Serializable {
  ...
  @OneToOne(mappedBy = "theModelingActivityEventSub")
  @JsonIgnore
  ...
  public ModelingActivityEvent theEventSuper(Event event) {
  ...
  public ModelingActivityEvent theCatalogEventToModelingActivities(
      Set<CatalogEvent> catalogEvents) {
  ...
  public String toString() {
    return "ModelingActivityEvent{" + "id=" + getId() + "}";
  }
}
