...
public class RoleTypeResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new roleTypeDTO, or with status {@code 400 (Bad Request)} if the roleType has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated roleTypeDTO,
     * or with status {@code 400 (Bad Request)} if the roleTypeDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the roleTypeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<RoleTypeDTO> updateRoleType(@RequestBody RoleTypeDTO roleTypeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, roleTypeDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the roleTypeDTO, or with status {@code 404 (Not Found)}.
     */
