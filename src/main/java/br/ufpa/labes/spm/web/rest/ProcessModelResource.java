...
public class ProcessModelResource {
   ...
   *     processModelDTO, or with status {@code 400 (Bad Request)} if the processModel has already
   *     an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/process-models")
  public ResponseEntity<ProcessModelDTO> createProcessModel(
      @RequestBody ProcessModelDTO processModelDTO) throws URISyntaxException {
   ...
   *     processModelDTO, or with status {@code 400 (Bad Request)} if the processModelDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the processModelDTO couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/process-models")
  public ResponseEntity<ProcessModelDTO> updateProcessModel(
      @RequestBody ProcessModelDTO processModelDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, processModelDTO.getId().toString()))
        .body(result);
  }
   ...
   *     processModelDTO, or with status {@code 404 (Not Found)}.
   */
