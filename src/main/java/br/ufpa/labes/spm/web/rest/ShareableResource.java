...
public class ShareableResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new shareableDTO, or with status {@code 400 (Bad Request)} if the shareable has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/shareables")
    public ResponseEntity<ShareableDTO> createShareable(@RequestBody ShareableDTO shareableDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated shareableDTO,
     * or with status {@code 400 (Bad Request)} if the shareableDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the shareableDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/shareables")
    public ResponseEntity<ShareableDTO> updateShareable(@RequestBody ShareableDTO shareableDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, shareableDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<ShareableDTO> getAllShareables() {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the shareableDTO, or with status {@code 404 (Not Found)}.
     */
