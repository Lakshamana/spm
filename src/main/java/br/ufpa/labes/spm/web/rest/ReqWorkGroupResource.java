...
public class ReqWorkGroupResource {
   ...
   *     reqWorkGroupDTO, or with status {@code 400 (Bad Request)} if the reqWorkGroup has already
   *     an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/req-work-groups")
  public ResponseEntity<ReqWorkGroupDTO> createReqWorkGroup(
      @RequestBody ReqWorkGroupDTO reqWorkGroupDTO) throws URISyntaxException {
   ...
   *     reqWorkGroupDTO, or with status {@code 400 (Bad Request)} if the reqWorkGroupDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the reqWorkGroupDTO couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/req-work-groups")
  public ResponseEntity<ReqWorkGroupDTO> updateReqWorkGroup(
      @RequestBody ReqWorkGroupDTO reqWorkGroupDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, reqWorkGroupDTO.getId().toString()))
        .body(result);
  }
   ...
   *     reqWorkGroupDTO, or with status {@code 404 (Not Found)}.
   */
