...
public class ResourceEstimationResource {
   ...
   *     resourceEstimation, or with status {@code 400 (Bad Request)} if the resourceEstimation has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/resource-estimations")
  public ResponseEntity<ResourceEstimation> createResourceEstimation(
      @RequestBody ResourceEstimation resourceEstimation) throws URISyntaxException {
   ...
   *     resourceEstimation, or with status {@code 400 (Bad Request)} if the resourceEstimation is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the resourceEstimation
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/resource-estimations")
  public ResponseEntity<ResourceEstimation> updateResourceEstimation(
      @RequestBody ResourceEstimation resourceEstimation) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, resourceEstimation.getId().toString()))
        .body(result);
  }
   ...
   *     resourceEstimation, or with status {@code 404 (Not Found)}.
   */
