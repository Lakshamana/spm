...
public class WebAPSEEObjectResource {
   ...
   *     webAPSEEObjectDTO, or with status {@code 400 (Bad Request)} if the webAPSEEObject has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/web-apsee-objects")
  public ResponseEntity<WebAPSEEObjectDTO> createWebAPSEEObject(
      @Valid @RequestBody WebAPSEEObjectDTO webAPSEEObjectDTO) throws URISyntaxException {
   ...
   *     webAPSEEObjectDTO, or with status {@code 400 (Bad Request)} if the webAPSEEObjectDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the webAPSEEObjectDTO couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/web-apsee-objects")
  public ResponseEntity<WebAPSEEObjectDTO> updateWebAPSEEObject(
      @Valid @RequestBody WebAPSEEObjectDTO webAPSEEObjectDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, webAPSEEObjectDTO.getId().toString()))
        .body(result);
  }
   ...
   *     webAPSEEObjectDTO, or with status {@code 404 (Not Found)}.
   */
