...
public class EnactionDescriptionResource {
   ...
   *     enactionDescriptionDTO, or with status {@code 400 (Bad Request)} if the enactionDescription
   *     has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/enaction-descriptions")
  public ResponseEntity<EnactionDescriptionDTO> createEnactionDescription(
      @RequestBody EnactionDescriptionDTO enactionDescriptionDTO) throws URISyntaxException {
    log.debug("REST request to save EnactionDescription : {}", enactionDescriptionDTO);
    if (enactionDescriptionDTO.getId() != null) {
      throw new BadRequestAlertException(
          "A new enactionDescription cannot already have an ID", ENTITY_NAME, "idexists");
    }
   ...
   *     enactionDescriptionDTO, or with status {@code 400 (Bad Request)} if the
   *     enactionDescriptionDTO is not valid, or with status {@code 500 (Internal Server Error)} if
   *     the enactionDescriptionDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/enaction-descriptions")
  public ResponseEntity<EnactionDescriptionDTO> updateEnactionDescription(
      @RequestBody EnactionDescriptionDTO enactionDescriptionDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, enactionDescriptionDTO.getId().toString()))
        .body(result);
  }
   ...
   *     enactionDescriptions in body.
   */
  @GetMapping("/enaction-descriptions")
  public List<EnactionDescriptionDTO> getAllEnactionDescriptions(
   ...
   *     enactionDescriptionDTO, or with status {@code 404 (Not Found)}.
   */
  ...
  public ResponseEntity<EnactionDescriptionDTO> getEnactionDescription(@PathVariable Long id) {
    ...
    Optional<EnactionDescriptionDTO> enactionDescriptionDTO =
        enactionDescriptionService.findOne(id);
