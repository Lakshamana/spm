...
public class VCSRepositoryResource {
   ...
   *     vCSRepository, or with status {@code 400 (Bad Request)} if the vCSRepository has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/vcs-repositories")
  public ResponseEntity<VCSRepository> createVCSRepository(@RequestBody VCSRepository vCSRepository)
   ...
   *     vCSRepository, or with status {@code 400 (Bad Request)} if the vCSRepository is not valid,
   *     or with status {@code 500 (Internal Server Error)} if the vCSRepository couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/vcs-repositories")
  public ResponseEntity<VCSRepository> updateVCSRepository(@RequestBody VCSRepository vCSRepository)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, vCSRepository.getId().toString()))
        .body(result);
  }
   ...
   *     vCSRepository, or with status {@code 404 (Not Found)}.
   */
