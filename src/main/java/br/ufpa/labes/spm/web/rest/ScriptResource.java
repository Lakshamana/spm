...
public class ScriptResource {
     ...
     */
    @GetMapping("/scripts")
    public List<ScriptDTO> getAllScripts(@RequestParam(required = false) String filter) {
        if ("thesubroutinesuper-is-null".equals(filter)) {
            log.debug("REST request to get all Scripts where theSubroutineSuper is null");
            return scriptService.findAllWhereTheSubroutineSuperIsNull();
        }
