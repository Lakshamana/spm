...
public class GraphicCoordinateResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new graphicCoordinateDTO, or with status {@code 400 (Bad Request)} if the graphicCoordinate has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/graphic-coordinates")
    public ResponseEntity<GraphicCoordinateDTO> createGraphicCoordinate(@RequestBody GraphicCoordinateDTO graphicCoordinateDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated graphicCoordinateDTO,
     * or with status {@code 400 (Bad Request)} if the graphicCoordinateDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the graphicCoordinateDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/graphic-coordinates")
    public ResponseEntity<GraphicCoordinateDTO> updateGraphicCoordinate(@RequestBody GraphicCoordinateDTO graphicCoordinateDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, graphicCoordinateDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<GraphicCoordinateDTO> getAllGraphicCoordinates(@RequestParam(required = false) String filter) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the graphicCoordinateDTO, or with status {@code 404 (Not Found)}.
     */
