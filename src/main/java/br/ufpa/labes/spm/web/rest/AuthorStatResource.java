...
public class AuthorStatResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new authorStatDTO, or with status {@code 400 (Bad Request)} if the authorStat has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/author-stats")
    public ResponseEntity<AuthorStatDTO> createAuthorStat(@RequestBody AuthorStatDTO authorStatDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated authorStatDTO,
     * or with status {@code 400 (Bad Request)} if the authorStatDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the authorStatDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/author-stats")
    public ResponseEntity<AuthorStatDTO> updateAuthorStat(@RequestBody AuthorStatDTO authorStatDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, authorStatDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the authorStatDTO, or with status {@code 404 (Not Found)}.
     */
