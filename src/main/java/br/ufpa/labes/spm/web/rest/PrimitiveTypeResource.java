...
public class PrimitiveTypeResource {
   ...
   *     primitiveType, or with status {@code 400 (Bad Request)} if the primitiveType has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/primitive-types")
  public ResponseEntity<PrimitiveType> createPrimitiveType(@RequestBody PrimitiveType primitiveType)
   ...
   *     primitiveType, or with status {@code 400 (Bad Request)} if the primitiveType is not valid,
   *     or with status {@code 500 (Internal Server Error)} if the primitiveType couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/primitive-types")
  public ResponseEntity<PrimitiveType> updatePrimitiveType(@RequestBody PrimitiveType primitiveType)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, primitiveType.getId().toString()))
        .body(result);
  }
   ...
   *     primitiveType, or with status {@code 404 (Not Found)}.
   */
