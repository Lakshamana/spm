...
public class CatalogEventResource {
   ...
   *     catalogEvent, or with status {@code 400 (Bad Request)} if the catalogEvent has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/catalog-events")
  public ResponseEntity<CatalogEvent> createCatalogEvent(@RequestBody CatalogEvent catalogEvent)
   ...
   *     catalogEvent, or with status {@code 400 (Bad Request)} if the catalogEvent is not valid, or
   *     with status {@code 500 (Internal Server Error)} if the catalogEvent couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/catalog-events")
  public ResponseEntity<CatalogEvent> updateCatalogEvent(@RequestBody CatalogEvent catalogEvent)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, catalogEvent.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the catalogEvent,
