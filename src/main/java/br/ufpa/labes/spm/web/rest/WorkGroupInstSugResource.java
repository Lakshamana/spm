...
public class WorkGroupInstSugResource {
   ...
   *     workGroupInstSugDTO, or with status {@code 400 (Bad Request)} if the workGroupInstSug has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/work-group-inst-sugs")
  public ResponseEntity<WorkGroupInstSugDTO> createWorkGroupInstSug(
      @RequestBody WorkGroupInstSugDTO workGroupInstSugDTO) throws URISyntaxException {
   ...
   *     workGroupInstSugDTO, or with status {@code 400 (Bad Request)} if the workGroupInstSugDTO is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the workGroupInstSugDTO
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/work-group-inst-sugs")
  public ResponseEntity<WorkGroupInstSugDTO> updateWorkGroupInstSug(
      @RequestBody WorkGroupInstSugDTO workGroupInstSugDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, workGroupInstSugDTO.getId().toString()))
        .body(result);
  }
  ...
  public List<WorkGroupInstSugDTO> getAllWorkGroupInstSugs(
   ...
   *     workGroupInstSugDTO, or with status {@code 404 (Not Found)}.
   */
