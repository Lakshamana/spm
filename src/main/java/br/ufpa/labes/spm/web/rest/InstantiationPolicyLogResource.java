...
public class InstantiationPolicyLogResource {
  ...
  public InstantiationPolicyLogResource(
      InstantiationPolicyLogRepository instantiationPolicyLogRepository) {
   ...
   *     instantiationPolicyLog, or with status {@code 400 (Bad Request)} if the
   *     instantiationPolicyLog has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/instantiation-policy-logs")
  public ResponseEntity<InstantiationPolicyLog> createInstantiationPolicyLog(
      @RequestBody InstantiationPolicyLog instantiationPolicyLog) throws URISyntaxException {
   ...
   *     instantiationPolicyLog, or with status {@code 400 (Bad Request)} if the
   *     instantiationPolicyLog is not valid, or with status {@code 500 (Internal Server Error)} if
   *     the instantiationPolicyLog couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/instantiation-policy-logs")
  public ResponseEntity<InstantiationPolicyLog> updateInstantiationPolicyLog(
      @RequestBody InstantiationPolicyLog instantiationPolicyLog) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, instantiationPolicyLog.getId().toString()))
        .body(result);
  }
   ...
   *     instantiationPolicyLog, or with status {@code 404 (Not Found)}.
   */
  ...
  public ResponseEntity<InstantiationPolicyLog> getInstantiationPolicyLog(@PathVariable Long id) {
    ...
    Optional<InstantiationPolicyLog> instantiationPolicyLog =
        instantiationPolicyLogRepository.findById(id);
