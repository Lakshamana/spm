...
public class ToolParameterResource {
   ...
   *     toolParameterDTO, or with status {@code 400 (Bad Request)} if the toolParameter has already
   *     an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/tool-parameters")
  public ResponseEntity<ToolParameterDTO> createToolParameter(
      @RequestBody ToolParameterDTO toolParameterDTO) throws URISyntaxException {
   ...
   *     toolParameterDTO, or with status {@code 400 (Bad Request)} if the toolParameterDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the toolParameterDTO couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, toolParameterDTO.getId().toString()))
        .body(result);
  }
   ...
   *     toolParameterDTO, or with status {@code 404 (Not Found)}.
   */
