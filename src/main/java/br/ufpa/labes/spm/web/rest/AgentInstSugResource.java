...
public class AgentInstSugResource {
   ...
   *     agentInstSug, or with status {@code 400 (Bad Request)} if the agentInstSug has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/agent-inst-sugs")
  public ResponseEntity<AgentInstSug> createAgentInstSug(@RequestBody AgentInstSug agentInstSug)
   ...
   *     agentInstSug, or with status {@code 400 (Bad Request)} if the agentInstSug is not valid, or
   *     with status {@code 500 (Internal Server Error)} if the agentInstSug couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/agent-inst-sugs")
  public ResponseEntity<AgentInstSug> updateAgentInstSug(@RequestBody AgentInstSug agentInstSug)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, agentInstSug.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the agentInstSug,
