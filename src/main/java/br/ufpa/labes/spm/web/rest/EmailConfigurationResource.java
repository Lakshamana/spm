...
public class EmailConfigurationResource {
   ...
   *     emailConfigurationDTO, or with status {@code 400 (Bad Request)} if the emailConfiguration
   *     has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/email-configurations")
  public ResponseEntity<EmailConfigurationDTO> createEmailConfiguration(
      @RequestBody EmailConfigurationDTO emailConfigurationDTO) throws URISyntaxException {
   ...
   *     emailConfigurationDTO, or with status {@code 400 (Bad Request)} if the
   *     emailConfigurationDTO is not valid, or with status {@code 500 (Internal Server Error)} if
   *     the emailConfigurationDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/email-configurations")
  public ResponseEntity<EmailConfigurationDTO> updateEmailConfiguration(
      @RequestBody EmailConfigurationDTO emailConfigurationDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, emailConfigurationDTO.getId().toString()))
        .body(result);
  }
   ...
   *     emailConfigurationDTO, or with status {@code 404 (Not Found)}.
   */
