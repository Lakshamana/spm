...
public class InstantiationSuggestionResource {
  ...
  public InstantiationSuggestionResource(
      InstantiationSuggestionService instantiationSuggestionService) {
   ...
   *     instantiationSuggestionDTO, or with status {@code 400 (Bad Request)} if the
   *     instantiationSuggestion has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/instantiation-suggestions")
  public ResponseEntity<InstantiationSuggestionDTO> createInstantiationSuggestion(
      @RequestBody InstantiationSuggestionDTO instantiationSuggestionDTO)
    ...
    if (instantiationSuggestionDTO.getId() != null) {
      throw new BadRequestAlertException(
          "A new instantiationSuggestion cannot already have an ID", ENTITY_NAME, "idexists");
    }
    InstantiationSuggestionDTO result =
        instantiationSuggestionService.save(instantiationSuggestionDTO);
   ...
   *     instantiationSuggestionDTO, or with status {@code 400 (Bad Request)} if the
   *     instantiationSuggestionDTO is not valid, or with status {@code 500 (Internal Server Error)}
   *     if the instantiationSuggestionDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/instantiation-suggestions")
  public ResponseEntity<InstantiationSuggestionDTO> updateInstantiationSuggestion(
      @RequestBody InstantiationSuggestionDTO instantiationSuggestionDTO)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, instantiationSuggestionDTO.getId().toString()))
        .body(result);
  }
   ...
   *     instantiationSuggestions in body.
   */
   ...
   *     instantiationSuggestionDTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/instantiation-suggestions/{id}")
  public ResponseEntity<InstantiationSuggestionDTO> getInstantiationSuggestion(
      @PathVariable Long id) {
    log.debug("REST request to get InstantiationSuggestion : {}", id);
    Optional<InstantiationSuggestionDTO> instantiationSuggestionDTO =
        instantiationSuggestionService.findOne(id);
