...
public class ConnectionTypeResource {
   ...
   *     connectionType, or with status {@code 400 (Bad Request)} if the connectionType has already
   *     an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/connection-types")
  public ResponseEntity<ConnectionType> createConnectionType(
      @RequestBody ConnectionType connectionType) throws URISyntaxException {
   ...
   *     connectionType, or with status {@code 400 (Bad Request)} if the connectionType is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the connectionType couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/connection-types")
  public ResponseEntity<ConnectionType> updateConnectionType(
      @RequestBody ConnectionType connectionType) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, connectionType.getId().toString()))
        .body(result);
  }
   ...
   *     connectionType, or with status {@code 404 (Not Found)}.
   */
