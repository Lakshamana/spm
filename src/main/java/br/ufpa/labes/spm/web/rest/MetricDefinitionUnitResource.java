...
public class MetricDefinitionUnitResource {
  ...
  public MetricDefinitionUnitResource(
   ...
   *     metricDefinitionUnit, or with status {@code 400 (Bad Request)} if the metricDefinitionUnit
   *     has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/metric-definition-units")
  public ResponseEntity<MetricDefinitionUnit> createMetricDefinitionUnit(
      @RequestBody MetricDefinitionUnit metricDefinitionUnit) throws URISyntaxException {
   ...
   *     metricDefinitionUnit couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/metric-definition-units")
  public ResponseEntity<MetricDefinitionUnit> updateMetricDefinitionUnit(
      @RequestBody MetricDefinitionUnit metricDefinitionUnit) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, metricDefinitionUnit.getId().toString()))
        .body(result);
  }
   ...
   *     metricDefinitionUnit, or with status {@code 404 (Not Found)}.
   */
  ...
  public ResponseEntity<MetricDefinitionUnit> getMetricDefinitionUnit(@PathVariable Long id) {
    ...
    Optional<MetricDefinitionUnit> metricDefinitionUnit =
        metricDefinitionUnitRepository.findById(id);
