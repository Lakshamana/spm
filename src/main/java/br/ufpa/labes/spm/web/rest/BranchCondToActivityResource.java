...
public class BranchConCondToActivityResource {
  ...
  public BranchConCondToActivityResource(
      BranchConCondToActivityService branchCondToActivityService) {
   ...
   *     branchCondToActivityDTO, or with status {@code 400 (Bad Request)} if the
   *     branchCondToActivity has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/branch-cond-to-activities")
  public ResponseEntity<BranchConCondToActivityDTO> createBranchConCondToActivity(
      @RequestBody BranchConCondToActivityDTO branchCondToActivityDTO) throws URISyntaxException {
    ...
    if (branchCondToActivityDTO.getId() != null) {
      throw new BadRequestAlertException(
          "A new branchCondToActivity cannot already have an ID", ENTITY_NAME, "idexists");
    }
   ...
   *     branchCondToActivityDTO, or with status {@code 400 (Bad Request)} if the
   *     branchCondToActivityDTO is not valid, or with status {@code 500 (Internal Server Error)} if
   *     the branchCondToActivityDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/branch-cond-to-activities")
  public ResponseEntity<BranchConCondToActivityDTO> updateBranchConCondToActivity(
      @RequestBody BranchConCondToActivityDTO branchCondToActivityDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, branchCondToActivityDTO.getId().toString()))
        .body(result);
  }
   ...
   *     branchCondToActivities in body.
   */
   ...
   *     branchCondToActivityDTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/branch-cond-to-activities/{id}")
  public ResponseEntity<BranchConCondToActivityDTO> getBranchConCondToActivity(
      @PathVariable Long id) {
    log.debug("REST request to get BranchConCondToActivity : {}", id);
    Optional<BranchConCondToActivityDTO> branchCondToActivityDTO =
        branchCondToActivityService.findOne(id);
