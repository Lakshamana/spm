...
public class PeopleInstSugResource {
   ...
   *     peopleInstSug, or with status {@code 400 (Bad Request)} if the peopleInstSug has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/people-inst-sugs")
  public ResponseEntity<PeopleInstSug> createPeopleInstSug(@RequestBody PeopleInstSug peopleInstSug)
   ...
   *     peopleInstSug, or with status {@code 400 (Bad Request)} if the peopleInstSug is not valid,
   *     or with status {@code 500 (Internal Server Error)} if the peopleInstSug couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/people-inst-sugs")
  public ResponseEntity<PeopleInstSug> updatePeopleInstSug(@RequestBody PeopleInstSug peopleInstSug)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, peopleInstSug.getId().toString()))
        .body(result);
  }
   ...
   *     peopleInstSug, or with status {@code 404 (Not Found)}.
   */
