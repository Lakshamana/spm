...
public class ArtifactParamResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new artifactParamDTO, or with status {@code 400 (Bad Request)} if the artifactParam has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/artifact-params")
    public ResponseEntity<ArtifactParamDTO> createArtifactParam(@RequestBody ArtifactParamDTO artifactParamDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated artifactParamDTO,
     * or with status {@code 400 (Bad Request)} if the artifactParamDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the artifactParamDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/artifact-params")
    public ResponseEntity<ArtifactParamDTO> updateArtifactParam(@RequestBody ArtifactParamDTO artifactParamDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, artifactParamDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<ArtifactParamDTO> getAllArtifactParams(@RequestParam(required = false) String filter) {
        if ("theparametersuper-is-null".equals(filter)) {
            log.debug("REST request to get all ArtifactParams where theParameterSuper is null");
            return artifactParamService.findAllWhereTheParameterSuperIsNull();
        }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the artifactParamDTO, or with status {@code 404 (Not Found)}.
     */
