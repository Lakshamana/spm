...
public class AssetStatResource {
   ...
   *     assetStat, or with status {@code 400 (Bad Request)} if the assetStat has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/asset-stats")
  public ResponseEntity<AssetStat> createAssetStat(@RequestBody AssetStat assetStat)
   ...
   *     assetStat, or with status {@code 400 (Bad Request)} if the assetStat is not valid, or with
   *     status {@code 500 (Internal Server Error)} if the assetStat couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/asset-stats")
  public ResponseEntity<AssetStat> updateAssetStat(@RequestBody AssetStat assetStat)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, assetStat.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the assetStat, or
