...
public class ResourceInstSugResource {
   ...
   *     resourceInstSugDTO, or with status {@code 400 (Bad Request)} if the resourceInstSug has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/resource-inst-sugs")
  public ResponseEntity<ResourceInstSugDTO> createResourceInstSug(
      @RequestBody ResourceInstSugDTO resourceInstSugDTO) throws URISyntaxException {
   ...
   *     resourceInstSugDTO, or with status {@code 400 (Bad Request)} if the resourceInstSugDTO is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the resourceInstSugDTO
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/resource-inst-sugs")
  public ResponseEntity<ResourceInstSugDTO> updateResourceInstSug(
      @RequestBody ResourceInstSugDTO resourceInstSugDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, resourceInstSugDTO.getId().toString()))
        .body(result);
  }
  ...
  public List<ResourceInstSugDTO> getAllResourceInstSugs() {
   ...
   *     resourceInstSugDTO, or with status {@code 404 (Not Found)}.
   */
