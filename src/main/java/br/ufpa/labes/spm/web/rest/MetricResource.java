...
public class MetricResource {
   ...
   */
  @PutMapping("/metrics")
  public ResponseEntity<MetricDTO> updateMetric(@RequestBody MetricDTO metricDTO)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, metricDTO.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the metricDTO, or
