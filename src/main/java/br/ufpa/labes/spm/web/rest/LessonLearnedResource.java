...
public class LessonLearnedResource {
   ...
   *     lessonLearned, or with status {@code 400 (Bad Request)} if the lessonLearned has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/lesson-learneds")
  public ResponseEntity<LessonLearned> createLessonLearned(@RequestBody LessonLearned lessonLearned)
   ...
   *     lessonLearned, or with status {@code 400 (Bad Request)} if the lessonLearned is not valid,
   *     or with status {@code 500 (Internal Server Error)} if the lessonLearned couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/lesson-learneds")
  public ResponseEntity<LessonLearned> updateLessonLearned(@RequestBody LessonLearned lessonLearned)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, lessonLearned.getId().toString()))
        .body(result);
  }
   ...
   *     lessonLearned, or with status {@code 404 (Not Found)}.
   */
