...
public class LessonLearnedResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new lessonLearnedDTO, or with status {@code 400 (Bad Request)} if the lessonLearned has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/lesson-learneds")
    public ResponseEntity<LessonLearnedDTO> createLessonLearned(@RequestBody LessonLearnedDTO lessonLearnedDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated lessonLearnedDTO,
     * or with status {@code 400 (Bad Request)} if the lessonLearnedDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the lessonLearnedDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/lesson-learneds")
    public ResponseEntity<LessonLearnedDTO> updateLessonLearned(@RequestBody LessonLearnedDTO lessonLearnedDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, lessonLearnedDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the lessonLearnedDTO, or with status {@code 404 (Not Found)}.
     */
