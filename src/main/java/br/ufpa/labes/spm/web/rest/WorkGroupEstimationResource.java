...
public class WorkGroupEstimationResource {
   ...
   *     workGroupEstimation, or with status {@code 400 (Bad Request)} if the workGroupEstimation
   *     has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/work-group-estimations")
  public ResponseEntity<WorkGroupEstimation> createWorkGroupEstimation(
      @RequestBody WorkGroupEstimation workGroupEstimation) throws URISyntaxException {
   ...
   *     workGroupEstimation, or with status {@code 400 (Bad Request)} if the workGroupEstimation is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the workGroupEstimation
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/work-group-estimations")
  public ResponseEntity<WorkGroupEstimation> updateWorkGroupEstimation(
      @RequestBody WorkGroupEstimation workGroupEstimation) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, workGroupEstimation.getId().toString()))
        .body(result);
  }
   ...
   *     workGroupEstimation, or with status {@code 404 (Not Found)}.
   */
