...
public class ActivityMetricResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new activityMetricDTO, or with status {@code 400 (Bad Request)} if the activityMetric has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/activity-metrics")
    public ResponseEntity<ActivityMetricDTO> createActivityMetric(@RequestBody ActivityMetricDTO activityMetricDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated activityMetricDTO,
     * or with status {@code 400 (Bad Request)} if the activityMetricDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the activityMetricDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/activity-metrics")
    public ResponseEntity<ActivityMetricDTO> updateActivityMetric(@RequestBody ActivityMetricDTO activityMetricDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, activityMetricDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<ActivityMetricDTO> getAllActivityMetrics(@RequestParam(required = false) String filter) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the activityMetricDTO, or with status {@code 404 (Not Found)}.
     */
