...
public class AssetRelationshipResource {
   ...
   *     assetRelationshipDTO, or with status {@code 400 (Bad Request)} if the assetRelationship has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/asset-relationships")
  public ResponseEntity<AssetRelationshipDTO> createAssetRelationship(
      @RequestBody AssetRelationshipDTO assetRelationshipDTO) throws URISyntaxException {
   ...
   *     assetRelationshipDTO, or with status {@code 400 (Bad Request)} if the assetRelationshipDTO
   *     is not valid, or with status {@code 500 (Internal Server Error)} if the
   *     assetRelationshipDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/asset-relationships")
  public ResponseEntity<AssetRelationshipDTO> updateAssetRelationship(
      @RequestBody AssetRelationshipDTO assetRelationshipDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, assetRelationshipDTO.getId().toString()))
        .body(result);
  }
   ...
   *     assetRelationshipDTO, or with status {@code 404 (Not Found)}.
   */
