...
public class DriverResource {
   ...
   *     driver, or with status {@code 400 (Bad Request)} if the driver is not valid, or with status
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, driver.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the driver, or
