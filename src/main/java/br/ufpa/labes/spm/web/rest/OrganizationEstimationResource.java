...
public class OrganizationEstimationResource {
  ...
  public OrganizationEstimationResource(
      OrganizationEstimationService organizationEstimationService) {
   ...
   *     organizationEstimationDTO, or with status {@code 400 (Bad Request)} if the
   *     organizationEstimation has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/organization-estimations")
  public ResponseEntity<OrganizationEstimationDTO> createOrganizationEstimation(
      @RequestBody OrganizationEstimationDTO organizationEstimationDTO) throws URISyntaxException {
    ...
    OrganizationEstimationDTO result =
        organizationEstimationService.save(organizationEstimationDTO);
   ...
   *     organizationEstimationDTO, or with status {@code 400 (Bad Request)} if the
   *     organizationEstimationDTO is not valid, or with status {@code 500 (Internal Server Error)}
   *     if the organizationEstimationDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/organization-estimations")
  public ResponseEntity<OrganizationEstimationDTO> updateOrganizationEstimation(
      @RequestBody OrganizationEstimationDTO organizationEstimationDTO) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, organizationEstimationDTO.getId().toString()))
        .body(result);
  }
   ...
   *     organizationEstimationDTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/organization-estimations/{id}")
  public ResponseEntity<OrganizationEstimationDTO> getOrganizationEstimation(
      @PathVariable Long id) {
    log.debug("REST request to get OrganizationEstimation : {}", id);
    Optional<OrganizationEstimationDTO> organizationEstimationDTO =
        organizationEstimationService.findOne(id);
