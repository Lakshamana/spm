...
public class AgentInstSuggestionToAgentResource {
  ...
  public AgentInstSuggestionToAgentResource(
      AgentInstSuggestionToAgentService agentInstSuggestionToAgentService) {
   ...
   *     agentInstSuggestionToAgentDTO, or with status {@code 400 (Bad Request)} if the
   *     agentInstSuggestionToAgent has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/agent-inst-suggestion-to-agents")
  public ResponseEntity<AgentInstSuggestionToAgentDTO> createAgentInstSuggestionToAgent(
      @RequestBody AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO)
      throws URISyntaxException {
    log.debug(
        "REST request to save AgentInstSuggestionToAgent : {}", agentInstSuggestionToAgentDTO);
    if (agentInstSuggestionToAgentDTO.getId() != null) {
      throw new BadRequestAlertException(
          "A new agentInstSuggestionToAgent cannot already have an ID", ENTITY_NAME, "idexists");
    }
    AgentInstSuggestionToAgentDTO result =
        agentInstSuggestionToAgentService.save(agentInstSuggestionToAgentDTO);
   ...
   *     agentInstSuggestionToAgentDTO, or with status {@code 400 (Bad Request)} if the
   *     agentInstSuggestionToAgentDTO is not valid, or with status {@code 500 (Internal Server
   *     Error)} if the agentInstSuggestionToAgentDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/agent-inst-suggestion-to-agents")
  public ResponseEntity<AgentInstSuggestionToAgentDTO> updateAgentInstSuggestionToAgent(
      @RequestBody AgentInstSuggestionToAgentDTO agentInstSuggestionToAgentDTO)
      throws URISyntaxException {
    log.debug(
        "REST request to update AgentInstSuggestionToAgent : {}", agentInstSuggestionToAgentDTO);
    if (agentInstSuggestionToAgentDTO.getId() == null) {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                ...
                true,
                ENTITY_NAME,
                agentInstSuggestionToAgentDTO.getId().toString()))
        .body(result);
  }
   ...
   *     agentInstSuggestionToAgents in body.
   */
   ...
   *     agentInstSuggestionToAgentDTO, or with status {@code 404 (Not Found)}.
   */
  @GetMapping("/agent-inst-suggestion-to-agents/{id}")
  public ResponseEntity<AgentInstSuggestionToAgentDTO> getAgentInstSuggestionToAgent(
      @PathVariable Long id) {
    log.debug("REST request to get AgentInstSuggestionToAgent : {}", id);
    Optional<AgentInstSuggestionToAgentDTO> agentInstSuggestionToAgentDTO =
        agentInstSuggestionToAgentService.findOne(id);
    return ResponseUtil.wrapOrNotFound(agentInstSuggestionToAgentDTO);
  }

  /**
   * {@code DELETE /agent-inst-suggestion-to-agents/:id} : delete the "id"
   * agentInstSuggestionToAgent.
   *
