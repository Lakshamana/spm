...
public class BranchConCondToActivityResource {
  ...
  public BranchConCondToActivityResource(
      BranchConCondToActivityService branchConCondToActivityService) {
   ...
   *     branchConCondToActivityDTO, or with status {@code 400 (Bad Request)} if the
  ...
  public ResponseEntity<BranchConCondToActivityDTO> createBranchConCondToActivity(
      @RequestBody BranchConCondToActivityDTO branchConCondToActivityDTO)
    ...
    BranchConCondToActivityDTO result =
        branchConCondToActivityService.save(branchConCondToActivityDTO);
   ...
   *     branchConCondToActivityDTO, or with status {@code 400 (Bad Request)} if the
   *     branchConCondToActivityDTO is not valid, or with status {@code 500 (Internal Server Error)}
   *     if the branchConCondToActivityDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, branchConCondToActivityDTO.getId().toString()))
        .body(result);
  }
   ...
   *     branchConCondToActivityDTO, or with status {@code 404 (Not Found)}.
   */
  ...
  public ResponseEntity<BranchConCondToActivityDTO> getBranchConCondToActivity(
    ...
    Optional<BranchConCondToActivityDTO> branchConCondToActivityDTO =
        branchConCondToActivityService.findOne(id);
