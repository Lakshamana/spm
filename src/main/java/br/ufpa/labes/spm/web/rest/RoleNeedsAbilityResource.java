...
public class RoleNeedsAbilityResource {
   ...
   *     roleNeedsAbility, or with status {@code 400 (Bad Request)} if the roleNeedsAbility has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/role-needs-abilities")
  public ResponseEntity<RoleNeedsAbility> createRoleNeedsAbility(
      @RequestBody RoleNeedsAbility roleNeedsAbility) throws URISyntaxException {
   ...
   *     roleNeedsAbility, or with status {@code 400 (Bad Request)} if the roleNeedsAbility is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the roleNeedsAbility couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/role-needs-abilities")
  public ResponseEntity<RoleNeedsAbility> updateRoleNeedsAbility(
      @RequestBody RoleNeedsAbility roleNeedsAbility) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, roleNeedsAbility.getId().toString()))
        .body(result);
  }
   ...
   *     roleNeedsAbility, or with status {@code 404 (Not Found)}.
   */
