...
public class EventResource {
   ...
   *     eventDTO, or with status {@code 400 (Bad Request)} if the event has already an ID.
   ...
   *     eventDTO, or with status {@code 400 (Bad Request)} if the eventDTO is not valid, or with
   *     status {@code 500 (Internal Server Error)} if the eventDTO couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/events")
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the eventDTO, or
