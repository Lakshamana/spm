...
public class NormalResource {
     ...
     */
    @PostMapping("/normals")
    public ResponseEntity<NormalDTO> createNormal(@RequestBody NormalDTO normalDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/normals")
    public ResponseEntity<NormalDTO> updateNormal(@RequestBody NormalDTO normalDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, normalDTO.getId().toString()))
            .body(result);
    }
