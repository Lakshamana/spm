...
public class ResourcePossibleUseResource {
   ...
   *     resourcePossibleUse, or with status {@code 400 (Bad Request)} if the resourcePossibleUse
   *     has already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/resource-possible-uses")
  public ResponseEntity<ResourcePossibleUse> createResourcePossibleUse(
      @RequestBody ResourcePossibleUse resourcePossibleUse) throws URISyntaxException {
   ...
   *     resourcePossibleUse, or with status {@code 400 (Bad Request)} if the resourcePossibleUse is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the resourcePossibleUse
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/resource-possible-uses")
  public ResponseEntity<ResourcePossibleUse> updateResourcePossibleUse(
      @RequestBody ResourcePossibleUse resourcePossibleUse) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, resourcePossibleUse.getId().toString()))
        .body(result);
  }
   ...
   *     resourcePossibleUse, or with status {@code 404 (Not Found)}.
   */
