...
public class GlobalActivityEventResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new globalActivityEventDTO, or with status {@code 400 (Bad Request)} if the globalActivityEvent has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/global-activity-events")
    public ResponseEntity<GlobalActivityEventDTO> createGlobalActivityEvent(@RequestBody GlobalActivityEventDTO globalActivityEventDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated globalActivityEventDTO,
     * or with status {@code 400 (Bad Request)} if the globalActivityEventDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the globalActivityEventDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/global-activity-events")
    public ResponseEntity<GlobalActivityEventDTO> updateGlobalActivityEvent(@RequestBody GlobalActivityEventDTO globalActivityEventDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, globalActivityEventDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<GlobalActivityEventDTO> getAllGlobalActivityEvents(@RequestParam(required = false) String filter) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the globalActivityEventDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    public ResponseEntity<GlobalActivityEventDTO> getGlobalActivityEvent(@PathVariable Long id) {
        ...
        Optional<GlobalActivityEventDTO> globalActivityEventDTO = globalActivityEventService.findOne(id);
