...
public class ProcessEventResource {
   ...
   *     processEvent, or with status {@code 400 (Bad Request)} if the processEvent has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/process-events")
  public ResponseEntity<ProcessEvent> createProcessEvent(@RequestBody ProcessEvent processEvent)
   ...
   *     processEvent, or with status {@code 400 (Bad Request)} if the processEvent is not valid, or
   *     with status {@code 500 (Internal Server Error)} if the processEvent couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/process-events")
  public ResponseEntity<ProcessEvent> updateProcessEvent(@RequestBody ProcessEvent processEvent)
      throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, processEvent.getId().toString()))
        .body(result);
  }
   ...
   * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the processEvent,
