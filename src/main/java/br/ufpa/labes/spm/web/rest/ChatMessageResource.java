...
public class ChatMessageResource {
   ...
   *     chatMessageDTO, or with status {@code 400 (Bad Request)} if the chatMessage has already an
   *     ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/chat-messages")
  public ResponseEntity<ChatMessageDTO> createChatMessage(
      @Valid @RequestBody ChatMessageDTO chatMessageDTO) throws URISyntaxException {
   ...
   *     chatMessageDTO, or with status {@code 400 (Bad Request)} if the chatMessageDTO is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the chatMessageDTO couldn't be
   *     updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, chatMessageDTO.getId().toString()))
        .body(result);
  }
   ...
   *     chatMessageDTO, or with status {@code 404 (Not Found)}.
   */
