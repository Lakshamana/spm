...
public class RequiredPeopleResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new requiredPeopleDTO, or with status {@code 400 (Bad Request)} if the requiredPeople has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/required-people")
    public ResponseEntity<RequiredPeopleDTO> createRequiredPeople(@RequestBody RequiredPeopleDTO requiredPeopleDTO) throws URISyntaxException {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated requiredPeopleDTO,
     * or with status {@code 400 (Bad Request)} if the requiredPeopleDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the requiredPeopleDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/required-people")
    public ResponseEntity<RequiredPeopleDTO> updateRequiredPeople(@RequestBody RequiredPeopleDTO requiredPeopleDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, requiredPeopleDTO.getId().toString()))
            .body(result);
    }
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the requiredPeopleDTO, or with status {@code 404 (Not Found)}.
     */
