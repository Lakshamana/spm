...
public class AgentAffinityAgentResource {
   ...
   *     agentAffinityAgent, or with status {@code 400 (Bad Request)} if the agentAffinityAgent has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/agent-affinity-agents")
  public ResponseEntity<AgentAffinityAgent> createAgentAffinityAgent(
      @RequestBody AgentAffinityAgent agentAffinityAgent) throws URISyntaxException {
   ...
   *     agentAffinityAgent, or with status {@code 400 (Bad Request)} if the agentAffinityAgent is
   *     not valid, or with status {@code 500 (Internal Server Error)} if the agentAffinityAgent
   *     couldn't be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/agent-affinity-agents")
  public ResponseEntity<AgentAffinityAgent> updateAgentAffinityAgent(
      @RequestBody AgentAffinityAgent agentAffinityAgent) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, agentAffinityAgent.getId().toString()))
        .body(result);
  }
   ...
   *     agentAffinityAgent, or with status {@code 404 (Not Found)}.
   */
