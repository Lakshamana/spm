...
public class FeedbackResource {
    ...
    public List<FeedbackDTO> getAllFeedbacks(@RequestParam(required = false) String filter) {
        if ("thesimpleconsuper-is-null".equals(filter)) {
            log.debug("REST request to get all Feedbacks where theSimpleConSuper is null");
            return feedbackService.findAllWhereTheSimpleConSuperIsNull();
        }
