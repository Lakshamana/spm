...
public class RequiredResourceResource {
   ...
   *     requiredResource, or with status {@code 400 (Bad Request)} if the requiredResource has
   *     already an ID.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PostMapping("/required-resources")
  public ResponseEntity<RequiredResource> createRequiredResource(
      @RequestBody RequiredResource requiredResource) throws URISyntaxException {
   ...
   *     requiredResource, or with status {@code 400 (Bad Request)} if the requiredResource is not
   *     valid, or with status {@code 500 (Internal Server Error)} if the requiredResource couldn't
   *     be updated.
   * @throws URISyntaxException if the Location URI syntax is incorrect.
   */
  @PutMapping("/required-resources")
  public ResponseEntity<RequiredResource> updateRequiredResource(
      @RequestBody RequiredResource requiredResource) throws URISyntaxException {
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(
                applicationName, true, ENTITY_NAME, requiredResource.getId().toString()))
        .body(result);
  }
   ...
   *     requiredResource, or with status {@code 404 (Not Found)}.
   */
