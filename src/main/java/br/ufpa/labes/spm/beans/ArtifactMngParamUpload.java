...
public class ArtifactMngParamUpload implements Serializable{
	...
	public ArtifactMngParamUpload(String username, String processIdent, String activityIdent, String artifactIdent, String comment, ArtifactMngContent artifactContent) {
